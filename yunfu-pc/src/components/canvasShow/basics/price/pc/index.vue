<template>
  <div class="product-list" :class="'terminal'+terminal">
    <div class="picListWarp" v-if="componentContent.arrangeType == '横向滑动'">
      <div class="picList" v-if="productData && productData.composeProducts">
        <div class="price-button-prev"></div>
        <div class="price-button-next"></div>
    ...
    <div v-else class="picList" >
      <ul
        v-if="productData && productData.composeProducts"
        class="clearfix"
        :class="'imgTextNum' +  componentContent.productNum"
      >
        <li class="item"
          v-for="(item,index) in productData.composeProducts.slice(0, componentContent.productRowNum * componentContent.productNum)"
          :key="index"
        >
          <div class="a-link" @click="jumpProductDetail(item)">
            <div class="itemImgBox">
