...
import com.shop.cereshop.business.dao.customer_service.CereCustomerServiceConfigDAO;
...
public class CereCustomerServiceConfigServiceImpl implements CereCustomerServiceConfigService {
    ...
    @Override
    public int save(CereCustomerServiceConfig config) {
        return cereCustomerServiceConfigDAO.insert(config);
    }
