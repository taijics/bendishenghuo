 ...
 */
@Data
public class ShopDiscountUpdateParam implements Serializable {
    /**
     * 店铺限时折扣活动id
     */
    @ApiModelProperty(value = "店铺限时折扣活动id",required = true)
    @NotNull(message = "店铺限时折扣活动id不能为空")
    ...
    @Valid
    private List<CereShopDiscountDetail> details;
