...
/**
 * cere_shop_seckill 修改店铺秒杀活动
 * @author
 */
@Data
@ApiModel(value = "ShopSeckillUpdateParam", description = "修改店铺秒杀活动请求")
public class ShopSeckillUpdateParam implements Serializable {
    /**
     * 店铺秒杀活动id
     */
    @ApiModelProperty(value = "店铺秒杀活动id",required = true)
    @NotNull(message = "店铺秒杀活动id不能为空")
