 ...
 */
package com.shop.cereshop.admin.service.message.impl;

import com.github.pagehelper.PageHelper;
import com.github.pagehelper.PageInfo;
import com.shop.cereshop.admin.dao.message.CerePlatfromMessageDAO;
...
public class CerePlatfromMessageServiceImpl implements CerePlatfromMessageService {
    ...
    public void save(MessageSaveParam param, CerePlatformUser user) throws CoBusinessException {
    ...
    @Override
    @Transactional(isolation= Isolation.DEFAULT,propagation= Propagation.REQUIRED,rollbackFor = {CoBusinessException.class, Exception.class})
    public void update(MessageUpdateParam param, CerePlatformUser user) throws CoBusinessException {
        String time = TimeUtils.yyMMddHHmmss();
        CerePlatfromMessage message=new CerePlatfromMessage();
        //修改短信模板
    ...
    @Override
    @Transactional(isolation= Isolation.DEFAULT,propagation= Propagation.REQUIRED,rollbackFor = {CoBusinessException.class, Exception.class})
    public void delete(MessageDeleteParam param, CerePlatformUser user) throws CoBusinessException {
        String time = TimeUtils.yyMMddHHmmss();
        //删除短信模板
