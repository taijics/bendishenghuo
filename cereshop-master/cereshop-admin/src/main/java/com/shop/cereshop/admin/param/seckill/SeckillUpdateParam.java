 ...
 */
@Data
@ApiModel(value = "SeckillUpdateParam", description = "修改平台秒杀活动请求")
public class SeckillUpdateParam implements Serializable {

    /**
     * 平台秒杀活动id
     */
    @ApiModelProperty(value = "平台秒杀活动id")
    @NotNull(message = "平台秒杀活动id不能为空")
