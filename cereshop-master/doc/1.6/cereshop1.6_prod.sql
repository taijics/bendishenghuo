...
CREATE TABLE `cere_activity_sign` (
  ...
  PRIMARY KEY (`sign_id`)
) ENGINE=InnoDB AUTO_INCREMENT=227 DEFAULT CHARSET=utf8 COMMENT='商家报名活动申请信息表';
...
) ENGINE=InnoDB AUTO_INCREMENT=310 DEFAULT CHARSET=utf8 COMMENT='售后单商品信息表';
...
CREATE TABLE `cere_buyer_bank` (
  ...
  PRIMARY KEY (`bank_id`)
) ENGINE=InnoDB AUTO_INCREMENT=69 DEFAULT CHARSET=utf8 COMMENT='客户绑定银行卡信息表';
...
) ENGINE=InnoDB AUTO_INCREMENT=474 DEFAULT CHARSET=utf8 COMMENT='客户收藏信息表';
...
CREATE TABLE `cere_buyer_coupon` (
  ...
  `coupon_code` varchar(128) DEFAULT NULL COMMENT '微信卡券的coupon_code',
  `create_time` varchar(20) DEFAULT NULL COMMENT '创建时间',
  `update_time` varchar(20) DEFAULT NULL COMMENT '更新时间'
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='商品足迹信息表';
...
) ENGINE=InnoDB AUTO_INCREMENT=1476600540083081286 DEFAULT CHARSET=utf8mb4 COMMENT='用户支付有礼记录';
...
) ENGINE=InnoDB AUTO_INCREMENT=485 DEFAULT CHARSET=utf8 COMMENT='客户收货地址信息表';
...
) ENGINE=InnoDB AUTO_INCREMENT=822 DEFAULT CHARSET=utf8 COMMENT='客户历史搜索信息表';
...
CREATE TABLE `cere_buyer_shop_coupon` (
  ...
  `update_time` varchar(20) DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=30037 DEFAULT CHARSET=utf8 COMMENT='客户关联商家优惠券信息表';
...
) ENGINE=InnoDB AUTO_INCREMENT=2123 DEFAULT CHARSET=utf8 COMMENT='客户信息表';
...
CREATE TABLE `cere_channel_coupon` (
  ...
  `product_id` bigint(20) NOT NULL COMMENT '商品id',
  `shop_id` bigint(20) NOT NULL COMMENT '店铺id',
  `create_time` varchar(20) COLLATE utf8mb4_bin NOT NULL COMMENT '创建时间',
  `update_time` varchar(20) COLLATE utf8mb4_bin NOT NULL COMMENT '更新时间',
  PRIMARY KEY (`shop_coupon_id`,`product_id`),
  KEY `idx_shop_id` (`shop_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='渠道券表';
...
CREATE TABLE `cere_close_advert` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键id',
  `buyer_user_id` bigint(20) DEFAULT NULL COMMENT '用户id',
...
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='关闭广告记录表';
...
) ENGINE=InnoDB AUTO_INCREMENT=331 DEFAULT CHARSET=utf8 COMMENT='拼单信息表';
...
CREATE TABLE `cere_collage_order_detail` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=353 DEFAULT CHARSET=utf8 COMMENT='拼单关联订单信息表';
...
CREATE TABLE `cere_credit_record` (
  ...
  `record_content` varchar(256) COLLATE utf8mb4_bin NOT NULL DEFAULT '' COMMENT '操作描述',
  `credit` int(11) NOT NULL DEFAULT '0' COMMENT '本次收入或支出积分',
  `remain_credit` int(11) NOT NULL DEFAULT '0' COMMENT '剩余积分',
  `create_time` varchar(20) COLLATE utf8mb4_bin NOT NULL COMMENT '创建时间',
  `update_time` varchar(20) COLLATE utf8mb4_bin NOT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`),
  KEY `idx_buyer_user_id` (`buyer_user_id`) USING BTREE COMMENT '用户id索引'
) ENGINE=InnoDB AUTO_INCREMENT=136 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='积分流水表';
...
CREATE TABLE `cere_credit_sign_setting` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='积分签到配置';
...
CREATE TABLE `cere_credit_signin_record` (
  ...
  `update_time` varchar(20) DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`),
  KEY `idx_buyer_user_id` (`buyer_user_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=65 DEFAULT CHARSET=utf8 COMMENT='积分签到表';
...
CREATE TABLE `cere_customer_service_config` (
  ...
  `create_time` varchar(20) COLLATE utf8mb4_bin NOT NULL COMMENT '创建时间',
  `update_time` varchar(20) COLLATE utf8mb4_bin NOT NULL COMMENT '更新时间',
  `permanent_code` varchar(256) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '永久授权码',
  `auth_corp_id` varchar(256) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '授权企业的id',
  PRIMARY KEY (`id`),
  UNIQUE KEY `idx_shop_id` (`shop_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='商家客服配置表';
...
CREATE TABLE `cere_live` (
  ...
  `anchor_nickname` varchar(32) DEFAULT '' COMMENT '主播昵称',
  `anchor_wechat` varchar(32) DEFAULT NULL COMMENT '主播微信号',
  `anchor_head_img` varchar(256) DEFAULT NULL COMMENT '主播头像',
  `live_type` int(11) DEFAULT NULL COMMENT '直播间类型 0-手机直播 1-推流',
  `screen_type` int(11) DEFAULT NULL COMMENT '屏幕方向 0-竖屏 1-横屏',
  `close_like` int(11) DEFAULT NULL COMMENT '是否关闭点赞',
  `close_goods_shelf` int(11) DEFAULT NULL COMMENT '是否关闭商品上架',
  `close_comment` int(11) DEFAULT NULL COMMENT '是否关闭评论',
  `close_playback` int(11) DEFAULT NULL COMMENT '是否关闭回放',
  `close_share` int(11) DEFAULT NULL COMMENT '是否关闭分享',
  `close_service` int(11) DEFAULT NULL COMMENT '是否关闭客服',
  `close_appointment` int(11) DEFAULT NULL COMMENT '是否关闭直播预约',
  `start_time` varchar(32) DEFAULT NULL COMMENT '开始时间',
  `end_time` varchar(32) DEFAULT NULL COMMENT '结束时间',
  `cover_img` varchar(256) DEFAULT NULL COMMENT '直播间背景图',
  `share_img` varchar(256) DEFAULT NULL COMMENT '直播间分享图片',
  `feeds_img` varchar(256) DEFAULT NULL COMMENT '封面图',
  `cover_media_id` varchar(256) DEFAULT NULL COMMENT '背景图媒体id',
  `share_media_id` varchar(256) DEFAULT NULL COMMENT '分享图媒体id',
  `feeds_media_id` varchar(256) DEFAULT NULL COMMENT '封面图媒体id',
  `room_id` int(11) DEFAULT NULL COMMENT '微信端-直播间id',
  `state` int(11) DEFAULT NULL COMMENT '状态: 0 - 待审核 1 - 审核已通过 2 - 审核未通过',
  `remark` varchar(32) DEFAULT NULL COMMENT '审核备注',
  `create_time` varchar(32) DEFAULT NULL COMMENT '创建时间',
  `update_time` varchar(32) DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=72 DEFAULT CHARSET=utf8mb4 COMMENT='直播表';
...
CREATE TABLE `cere_live_examine` (
  ...
  `update_time` varchar(20) COLLATE utf8mb4_bin NOT NULL COMMENT '更新时间',
  KEY `id` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=27 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='直播间重新审核表';
...
CREATE TABLE `cere_live_product` (
  ...
  `shop_id` bigint(20) NOT NULL COMMENT '店铺id',
  `product_id` bigint(20) NOT NULL COMMENT '商品id',
  `goods_id` int(11) DEFAULT NULL COMMENT '微信直播商品id',
  `product_name` varchar(32) DEFAULT NULL COMMENT '商品名称',
  `product_image` varchar(256) DEFAULT NULL COMMENT '商品封面图',
  `product_image_media_id` varchar(256) DEFAULT NULL COMMENT '商品封面图媒体id',
  `price_type` int(11) NOT NULL COMMENT '价格类型 1- 一口价 2-价格区间 3-折扣价',
  `fixed_price` decimal(10,2) DEFAULT NULL COMMENT '一口价 当price_type = 1时有值',
  `market_price` decimal(10,2) DEFAULT NULL COMMENT '市场价 当price_type = 3时有值',
  `original_price` decimal(10,2) DEFAULT NULL COMMENT '现价 当price_type = 3时可能有值',
  `min_price` decimal(10,2) DEFAULT NULL COMMENT '最低价 当price_type = 2时有值',
  `max_price` decimal(10,2) DEFAULT NULL COMMENT '最高价 当price_type = 2时有值',
  `stock_number` int(11) NOT NULL DEFAULT '0' COMMENT '商品库存',
  `total` int(11) NOT NULL COMMENT '商品初始库存',
  `state` int(11) DEFAULT NULL COMMENT '状态 0-待审核 1-审核通过 2-审核失败',
  `remark` varchar(32) DEFAULT NULL COMMENT '备注',
  `create_time` varchar(32) NOT NULL COMMENT '创建时间',
  `update_time` varchar(32) NOT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=48 DEFAULT CHARSET=utf8mb4 COMMENT='直播间商品表';
...
CREATE TABLE `cere_live_product_examine` (
  ...
  `update_time` varchar(20) COLLATE utf8mb4_bin NOT NULL COMMENT '更新时间',
  KEY `id` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='直播间商品重新审核表';
...
CREATE TABLE `cere_live_product_rel` (
  ...
  `create_time` varchar(32) NOT NULL COMMENT '创建时间',
  `update_time` varchar(32) NOT NULL COMMENT '修改时间',
  PRIMARY KEY (`live_id`,`live_product_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='直播间和直播间商品的关联表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='直播商品销售统计';
...
CREATE TABLE `cere_live_subscribe` (
  ...
  `update_time` varchar(20) COLLATE utf8mb4_bin NOT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='直播订阅表';
...
) ENGINE=InnoDB AUTO_INCREMENT=183 DEFAULT CHARSET=utf8 COMMENT='会员签到表';
...
) ENGINE=InnoDB AUTO_INCREMENT=3249 DEFAULT CHARSET=utf8 COMMENT='系统消息表';
...
) ENGINE=InnoDB AUTO_INCREMENT=289 DEFAULT CHARSET=utf8 COMMENT='售后单信息表';
...
) ENGINE=InnoDB AUTO_INCREMENT=45 DEFAULT CHARSET=utf8 COMMENT='物流方案设置信息表';
...
) ENGINE=InnoDB AUTO_INCREMENT=2682 DEFAULT CHARSET=utf8 COMMENT='父订单信息表';
...
CREATE TABLE `cere_order_product` (
  ...
  `SKU` varchar(50) DEFAULT NULL COMMENT 'SKU',
  `weight` decimal(15,2) DEFAULT NULL COMMENT '重量',
  `type` tinyint(1) DEFAULT NULL COMMENT '所属订单类型  1-常规订单 2-赠品营销子订单',
  `write_number` int(10) DEFAULT NULL COMMENT '已核销数量',
  `write_code` varchar(255) DEFAULT NULL COMMENT '核销码地址',
...
) ENGINE=InnoDB AUTO_INCREMENT=2868 DEFAULT CHARSET=utf8 COMMENT='订单商品信息表';
...
) ENGINE=InnoDB AUTO_INCREMENT=991 DEFAULT CHARSET=utf8 COMMENT='订单对账单信息表';
...
CREATE TABLE `cere_pay_log` (
  ...
  `create_time` varchar(20) DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1474749642121801813 DEFAULT CHARSET=utf8 COMMENT='支付日志信息表';
...
CREATE TABLE `cere_platform_activity` (
  ...
  `apply_category` bigint(20) DEFAULT NULL COMMENT '可用类别',
  `sync_card` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否同步微信卡券 1-同步 0-不同步',
  `card_title` varchar(64) DEFAULT NULL COMMENT '卡券标题',
  `card_color` varchar(64) DEFAULT NULL COMMENT '卡券主题色',
  `card_notice` varchar(64) DEFAULT NULL COMMENT '卡券使用须知',
  `card_id` varchar(64) DEFAULT NULL COMMENT '关联的微信卡券id',
  `state` tinyint(1) DEFAULT '0' COMMENT '活动状态  0-报名未开始 1-报名进行中 2-活动待开始 3-活动进行中 4-活动已结束',
  `create_time` varchar(20) DEFAULT NULL COMMENT '创建时间',
  `update_time` varchar(20) DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`activity_id`)
) ENGINE=InnoDB AUTO_INCREMENT=96 DEFAULT CHARSET=utf8 COMMENT='平台优惠券活动信息表';
...
CREATE TABLE `cere_platform_business` (
  ...
  `token` varchar(128) DEFAULT NULL COMMENT '商家用户token',
  `state` tinyint(1) DEFAULT NULL COMMENT '是否启用 1-是 0-否',
  `create_time` varchar(20) DEFAULT NULL COMMENT '创建时间',
  `update_time` varchar(20) DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`business_user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=224 DEFAULT CHARSET=utf8 COMMENT='平台商家用户表';
...
) ENGINE=InnoDB AUTO_INCREMENT=47 DEFAULT CHARSET=utf8 COMMENT='画布信息表';
...
CREATE TABLE `cere_platform_collection` (
  ...
  `collection_code` varchar(255) DEFAULT NULL COMMENT '平台收款码地址',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='平台收款码信息表';
...
CREATE TABLE `cere_platform_dict` (
  ...
  `update_time` varchar(20) DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`dict_id`)
) ENGINE=InnoDB AUTO_INCREMENT=1908 DEFAULT CHARSET=utf8 COMMENT='数据字典信息表';
...
) ENGINE=InnoDB AUTO_INCREMENT=60 DEFAULT CHARSET=utf8 COMMENT='平台限时折扣活动信息表';
...
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 COMMENT='平台标签信息表';
...
CREATE TABLE `cere_platform_log` (
  ...
  PRIMARY KEY (`log_id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='平台系统日志表';
...
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8mb4 COMMENT='平台会员等级信息表';
...
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8mb4 COMMENT='会员权益信息表';
...
) ENGINE=InnoDB AUTO_INCREMENT=3843 DEFAULT CHARSET=utf8 COMMENT='权限菜单信息表';
...
-- ----------------------------
BEGIN;
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (1, 0, '系统管理', '', 'system', 'zk-icon-menu', '目录菜单', 'catalog', 1, 1, '2020-11-12 11:44:56', '2021-12-17 16:23:25');
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (2, 1, '字典管理', '', '/setup/dict', 'el-icon-place', '字典菜单', 'menu', 2, 1, '2020-11-12 12:44:56', '2020-11-23 14:49:08');
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (3, 1, '角色管理', '', '/setup/role', 'el-icon-warning-outline', '角色菜单', 'menu', 3, 1, '2020-11-12 13:44:56', '2021-11-02 14:49:54');
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (4, 1, '菜单管理', '', '/setup/tabs', 'el-icon-location-outline', '菜单', 'menu', 4, 1, '2020-11-12 15:44:56', '2020-12-07 17:28:09');
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (5, 1, '用户管理', '', '/setup/user', 'el-icon-zoom-in', '用户菜单', 'menu', 5, 1, '2020-11-12 16:44:56', '2020-11-23 14:50:04');
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (6, 2, '新增', '', 'save', '', '新增按钮', 'button', 6, 1, '2020-11-12 17:44:56', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (7, 2, '修改', '', 'update', '', '修改按钮', 'button', 7, 1, '2020-11-12 14:45:08', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (8, 2, '删除', '', 'delete', '', '删除按钮', 'button', 8, 1, '2020-11-12 14:46:05', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (9, 4, '新增父级菜单', '', 'save', 'el-icon-eleme', '新增按钮', 'button', 9, 1, '2020-11-12 16:43:44', '2020-12-07 14:50:16');
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (10, 4, '新增子级菜单', '', 'update', 'el-icon-minus', '修改按钮', 'button', 10, 1, '2020-11-12 16:43:56', '2020-12-07 14:50:39');
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (11, 4, '新增子级按钮', '', 'delete', 'el-icon-download', '删除按钮', 'button', 11, 1, '2020-11-12 16:44:07', '2020-12-07 14:50:54');
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (17, 0, '客户管理', '', 'customer', 'el-icon-user', '客户', 'menu', 17, 1, '2020-11-24 09:16:30', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (19, 0, '客户管理', '', 'sensitive', 'el-icon-finished', '客户管理', 'menu', 19, 1, '2020-11-24 09:31:27', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (20, 0, '231', '', '213', 'el-icon-suitcase-1', '321', 'menu', 20, 1, '2020-11-24 09:35:17', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (21, 18, '客户管理', '', '/customer/customerMage', 'el-icon-help', '啥', 'menu', 21, 1, '2020-11-24 09:41:37', '2020-12-07 17:50:40');
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (22, 18, '标签管理', '', '/customer/tips', 'el-icon-document-remove', '标签', 'menu', 22, 1, '2020-11-24 09:42:23', '2020-12-07 17:51:06');
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (23, 0, '评论', '', 'comment', 'el-icon-edit', '评论', 'menu', 23, 1, '2020-11-24 09:44:58', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (24, 0, '评论管理', '', 'comment', 'zk-icon-scene', '评论', 'catalog', 24, 1, '2020-11-24 09:45:29', '2021-12-17 16:27:13');
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (25, 24, '敏感词管理', '', '/comment/sensitive', 'el-icon-magic-stick', '敏感词', 'menu', 25, 1, '2020-11-24 09:46:18', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (26, 24, '评论管理', '', '/comment/commentSys', 'el-icon-chat-dot-round', '搜索', 'menu', 26, 1, '2020-11-24 09:46:47', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (27, 2, '添加', '', '1', 'el-icon-plus', '', 'button', 27, 1, '2020-12-07 01:32:37', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (28, 0, '评论', '', 'comment', 'el-icon-thumb', '这是评论', 'menu', 28, 1, '2020-12-07 14:21:46', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (29, 0, '售后处理', '', 'comment/sensitive', 'el-icon-headset', '售后', 'menu', 29, 1, '2020-12-07 14:23:51', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (33, 0, '平台活动', '', '/active', 'el-icon-monitor', '', 'catalog', 32, 1, '2020-12-07 14:27:29', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (34, 0, '商品管理', '', 'renovation', 'zk-icon-activity', '', 'catalog', 34, 1, '2020-12-07 14:29:02', '2021-12-17 16:24:33');
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (37, 34, '商品类别', '', '/renovation/commdityClass', 'el-icon-film', '', 'menu', 37, 1, '2020-12-07 14:31:55', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (38, 0, '商家管理', '', '/business', 'zk-icon-store-set', '', 'catalog', 38, 1, '2020-12-07 14:33:23', '2021-12-17 16:24:43');
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (39, 38, '商家列表', '', '/business/businessList', 'el-icon-set-up', '', 'menu', 39, 1, '2020-12-07 14:33:56', '2021-12-10 10:46:07');
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (40, 38, '入驻申请', '', '/business/settlement', 'el-icon-mobile', '1', 'menu', 40, 1, '2020-12-07 14:49:00', '2021-12-10 10:44:34');
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (47, 22, '导出标签', '', 'excel', 'el-icon-minus', '', 'button', 47, 1, '2020-12-07 15:06:28', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (48, 24, '关键词管理', '', '/comment/keyword', 'el-icon-help', '', 'menu', 48, 1, '2020-12-08 20:18:02', '2021-12-15 20:20:50');
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (52, 0, '订单', '', '/order', 'el-icon-tickets', '', 'catalog', 52, 0, '2020-12-16 20:22:55', '2020-12-16 21:16:56');
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (53, 52, '待处理订单', '', '/order/pending', 'el-icon-alarm-clock', '', 'menu', 53, 0, '2020-12-16 20:23:44', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (54, 52, '售后订单', '', '/order/aftersale', 'el-icon-truck', '', 'menu', 54, 0, '2020-12-16 20:24:02', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (55, 0, '商品', '', 'commodity', 'el-icon-present', '', 'catalog', 55, 0, '2020-12-16 20:24:42', '2020-12-16 21:16:18');
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (56, 55, '商品管理', '', '/commodity/commoditySystem', 'el-icon-crop', '', 'menu', 56, 0, '2020-12-16 20:25:05', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (57, 55, '商品分组', '', '/commodity/commodityList', 'el-icon-set-up', '', 'menu', 57, 0, '2020-12-16 20:25:49', '2020-12-16 20:25:55');
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (58, 0, '店铺', '', '/shop', 'el-icon-data-board', '', 'catalog', 58, 0, '2020-12-16 20:26:37', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (59, 58, '店铺装修', '', 'https://ceres.zkthink.com/merchant-web/canvas.html', 'el-icon-thumb', '', 'menu', 59, 0, '2020-12-16 20:27:05', '2021-09-27 17:11:58');
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (60, 58, '素材管理', '', '/shop/material', 'el-icon-data-analysis', '', 'menu', 60, 0, '2020-12-16 20:27:38', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (61, 0, '设置', '', '/system', 'el-icon-setting', '', 'catalog', 61, 0, '2020-12-16 20:28:44', '2020-12-16 21:16:32');
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (62, 61, '店铺设置', '', '/system/shopSys', 'el-icon-monitor', '', 'menu', 62, 0, '2020-12-16 20:29:19', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (63, 61, '物流设置', '', '/system/logistics', 'el-icon-truck', '', 'menu', 63, 0, '2020-12-16 20:29:44', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (64, 0, '财务', '', '/finance', 'el-icon-shopping-bag-1', '', 'catalog', 64, 0, '2020-12-16 20:30:17', '2020-12-16 21:16:37');
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (65, 64, '财务明细', '', '/finance/list', 'el-icon-notebook-2', '', 'menu', 65, 0, '2020-12-16 20:30:33', '2021-12-23 17:28:27');
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (66, 64, '收款账户', '', '/finance/account', 'el-icon-files', '', 'menu', 66, 0, '2020-12-16 20:30:53', '2021-12-23 17:29:10');
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (67, 0, '分销员', '', '/Distributor/DistributorIndex', 'el-icon-help', '', 'catalog', 67, 0, '2020-12-16 20:31:31', '2021-12-24 10:37:14');
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (68, 0, '平台活动', '', '/active', 'el-icon-finished', '', 'catalog', 68, 0, '2020-12-16 20:31:55', '2021-12-23 17:27:29');
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (69, 0, '系统管理', '', '/setup', 'el-icon-cpu', '', 'catalog', 69, 0, '2020-12-16 20:32:27', '2020-12-16 21:16:46');
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (70, 69, '用户管理', '', '/setup/user', 'el-icon-user', '', 'menu', 70, 0, '2020-12-16 20:32:51', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (71, 69, '角色管理', '', '/setup/role', 'el-icon-document-add', '', 'menu', 71, 0, '2020-12-16 20:33:16', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (72, 69, '菜单管理', '', '/setup/tabs', 'el-icon-tickets', '', 'menu', 72, 0, '2020-12-16 20:33:36', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (73, 64, '保证金', '', '/finance/bond', 'el-icon-check', '', 'menu', 73, 0, '2020-12-16 22:26:08', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (74, 0, '财务管理', '', '/finance', 'el-icon-receiving', '', 'catalog', 74, 1, '2020-12-17 21:47:27', '2021-09-03 19:01:37');
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (75, 74, '提现申请', '', '/finance/withdrawal', 'el-icon-mobile', '', 'menu', 75, 1, '2020-12-17 21:53:16', '2020-12-17 21:53:33');
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (76, 74, '财务概况', '', '/finance/overview', 'el-icon-stopwatch', '', 'menu', 76, 1, '2020-12-17 21:59:24', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (77, 74, '保证金', '', '/finance/bond', 'el-icon-attract', '', 'menu', 77, 1, '2020-12-17 22:40:44', '2020-12-17 22:41:56');
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (78, 74, '用户提现申请', NULL, '/finance/application', 'el-icon-bank-card', NULL, 'menu', 78, 1, '2020-12-17 22:40:45', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (79, 56, '批量导入', '', 'l', 'el-icon-minus', '', 'button', 79, 0, '2020-12-18 00:28:06', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (80, 56, '新增商品', '', 's', 'el-icon-minus', '', 'button', 80, 0, '2020-12-18 00:28:34', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (81, 57, '新增分组', '', 'add', 'el-icon-minus', '', 'button', 81, 0, '2020-12-18 00:29:28', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (82, 60, '新增标签', '', 'add', 'el-icon-minus', '', 'button', 82, 0, '2020-12-18 00:30:06', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (83, 60, '上传', '', 'upload', 'el-icon-minus', '', 'button', 83, 0, '2020-12-18 00:30:29', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (84, 63, '新建方案', '', 'add', 'el-icon-minus', '', 'button', 84, 0, '2020-12-18 00:30:58', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (496, 0, '终端装修', '', 'https://ceres.zkthink.com/admin-web/canvas.html', 'zk-icon-shop-decoration', '页面装修', 'catalog', 496, 1, '2021-01-13 23:37:04', '2021-12-17 16:25:05');
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (578, 0, '消息中心', '', 'notice', 'zk-icon-management-server', '消息中心', 'catalog', 578, 1, '2021-03-11 21:24:32', '2021-12-17 16:25:16');
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (579, 578, '历史消息', '', '/notice/history', 'el-icon-chat-dot-square', '历史消息', 'menu', 579, 1, '2021-03-11 21:25:43', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (580, 578, '消息推送', '', '/notice/push', 'el-icon-chat-line-square', '消息推送', 'menu', 580, 1, '2021-03-11 21:26:21', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (707, 0, '营销活动', NULL, '/marketing', 'el-icon-stopwatch', NULL, 'catalog', 707, 0, '2021-03-21 15:47:37', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (708, 707, '优惠券管理', NULL, '/marketing/coupon', 'el-icon-s-goods', NULL, 'menu', 708, 0, '2021-03-21 15:47:37', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (709, 707, '拼团', NULL, '/marketing/group', 'el-icon-suitcase-1', NULL, 'menu', 709, 0, '2021-03-21 15:47:37', '2021-12-24 17:07:09');
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (710, 707, '秒杀', NULL, '/marketing/spike', 'el-icon-alarm-clock', NULL, 'menu', 710, 0, '2021-03-21 15:47:37', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (711, 707, '限时折扣', NULL, '/marketing/discount', 'el-icon-alarm-clock', NULL, 'menu', 711, 0, '2021-03-21 15:47:37', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (712, 0, '客户管理', NULL, '/customer', 'el-icon-user', NULL, 'catalog', 712, 0, '2021-03-21 15:47:37', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (713, 712, '客户列表', NULL, '/customer/customerList', 'el-icon-user', NULL, 'menu', 713, 0, '2021-03-21 15:47:37', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (714, 712, '标签列表', NULL, '/customer/tagList', 'el-icon-collection-tag', NULL, 'menu', 714, 0, '2021-03-21 15:47:37', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (715, 712, '客户分群', NULL, '/customer/clusteringList', 'el-icon-connection', NULL, 'menu', 715, 0, '2021-03-21 15:47:37', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (747, 712, '运营计划', '', '/customer/operate', 'el-icon-bank-card', '', 'menu', 747, 0, '2021-03-18 18:31:30', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (910, 1, '商家菜单', '', '/setup/businessMenus', 'el-icon-takeaway-box', '管理商家菜单', 'menu', 880, 1, '2021-03-26 23:15:19', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (911, 33, '优惠券活动', '', '/active/couponlist', 'el-icon-notebook-2', '', 'menu', 887, 1, '2021-08-21 17:39:04', '2021-12-07 15:47:05');
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (914, 33, '秒杀活动', '', '/active/seckilllist', 'el-icon-notebook-2', '', 'menu', 884, 1, '2021-08-21 17:56:10', '2021-12-07 15:46:51');
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (915, 33, '限时折扣', '', '/active/discountlist', 'el-icon-tickets', '', 'menu', 885, 1, '2021-08-21 17:56:58', '2021-12-07 15:46:56');
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (916, 33, '支付有礼', '', '/active/politelist', 'el-icon-reading', '', 'menu', 886, 1, '2021-08-21 17:57:33', '2021-12-07 15:47:01');
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (918, 0, '会员管理', '', '/member', 'zk-icon-management-customer', '', 'catalog', 18, 1, '2021-08-24 11:02:34', '2021-12-17 16:23:50');
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (919, 918, '会员管理', '', '/member/memberList', 'el-icon-copy-document', '', 'menu', 893, 1, '2021-08-24 14:54:18', '2021-08-28 16:10:53');
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (920, 918, '会员标签', '', '/member/tips', 'el-icon-collection-tag', '', 'menu', 894, 1, '2021-08-24 16:09:53', '2021-08-26 14:32:03');
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (922, 920, '导出', '', 'excel', 'el-icon-minus', '', 'button', 896, 1, '2021-08-24 16:17:36', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (923, 918, '会员权益', '', '/member/equity', 'el-icon-medal', '', 'menu', 989, 1, '2021-08-24 16:43:12', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (924, 918, '会员等级', '', '/member/levelList', 'el-icon-sell', '', 'menu', 990, 1, '2021-08-25 17:50:46', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (927, 0, '订单管理', '', '/order', 'el-icon-tickets', '', 'catalog', 16, 1, '2021-08-28 19:33:11', '2021-09-03 19:00:33');
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (928, 927, '订单管理', '', '/order/pending', 'el-icon-alarm-clock', '', 'menu', 993, 1, '2021-08-28 19:43:40', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (929, 927, '售后处理', '', '/order/after', 'el-icon-umbrella', '', 'menu', 994, 1, '2021-08-28 19:45:02', '2021-08-28 20:57:11');
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (979, 707, '场景营销', '', '/marketing/scene', 'el-icon-picture-outline-round', '', 'menu', 1011, 0, '2021-08-30 12:01:30', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (980, 707, '组合捆绑', '', '/marketing/compose', 'el-icon-suitcase', '', 'menu', 1012, 0, '2021-08-30 12:02:28', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (981, 707, '定价捆绑', '', '/marketing/price', 'el-icon-receiving', '', 'menu', 1013, 0, '2021-08-30 12:03:04', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (1201, 34, '商品管理', '', '/renovation/commoditySystem', 'el-icon-setting', '', 'menu', 36, 1, '2021-09-03 11:11:07', '2021-09-03 11:12:00');
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (1603, 1602, '汽车管理', '', '/carManage/carList', 'el-icon-setting', '汽车列表管理', 'menu', 1172, 1, '2021-11-20 16:15:25', '2021-11-20 16:48:43');
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (1604, 1602, '汽车类别', '', '/carManage/carType', 'el-icon-film', '汽车类别', 'menu', 1173, 1, '2021-11-20 17:00:43', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (1605, 1602, '类别参数', '', '/carManage/typeParam', 'el-icon-tickets', '类别参数', 'menu', 1174, 1, '2021-11-21 16:49:46', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (1607, 1606, '房产管理', '', '/houseManage/houseList', 'el-icon-setting', '', 'button', 1176, 1, '2021-11-24 09:42:13', '2021-11-24 09:43:25');
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (1609, 1608, '房产管理', '', '/houseManage/houseList', 'el-icon-setting', '', 'menu', 1178, 1, '2021-11-24 09:46:10', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (1610, 1608, '房产类型', '', '/houseManage/houseType', 'el-icon-film', '', 'menu', 1179, 1, '2021-11-24 09:53:26', '2021-11-24 09:56:12');
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (1611, 1608, '类别参数', '', '/houseManage/houseTypeParam', 'el-icon-notebook-2', '', 'menu', 1180, 1, '2021-11-24 09:55:32', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (1613, 1612, '沙石管理', '', '/sandManage/sandList', 'el-icon-setting', '', 'menu', 1182, 1, '2021-11-24 10:03:11', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (1614, 1612, '沙石类型', '', '/sandManage/sandType', 'el-icon-film', '', 'menu', 1183, 1, '2021-11-24 10:04:03', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (1615, 1612, '类别分类', '', '/sandManage/sandTypeParam', 'el-icon-notebook-2', '', 'menu', 1184, 1, '2021-11-24 10:04:58', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (1617, 1616, '再生管理', '', '/renewManage/renewList', 'el-icon-setting', '', 'menu', 1186, 1, '2021-11-24 10:16:45', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (1618, 1616, '再生类型', '', '/renewManage/renewType', 'el-icon-film', '', 'menu', 1187, 1, '2021-11-24 10:17:22', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (1619, 1616, '类别参数', '', '/renewManage/renewTypeParam', 'el-icon-notebook-2', '', 'menu', 1188, 1, '2021-11-24 10:18:10', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (1621, 1620, '税务管理', '', '/taxManage/taxList', 'el-icon-setting', '', 'menu', 1190, 1, '2021-11-24 10:20:57', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (1622, 1620, '税务类型', '', '/taxManage/taxType', 'el-icon-film', '', 'menu', 1191, 1, '2021-11-24 10:21:26', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (1623, 1620, '类别参数', '', '/taxManage/taxTypeParam', 'el-icon-notebook-2', '', 'menu', 1192, 1, '2021-11-24 10:21:59', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (1624, 0, '直播管理', '', '/liveMenu', 'el-icon-notebook-1', '', 'menu', 1193, 1, '2021-12-01 17:09:42', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (1625, 0, '直播管理', '', '/liveMenu', 'zk-icon-system', '', 'catalog', 1194, 1, '2021-12-01 17:11:55', '2021-12-17 16:26:02');
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (1626, 0, '广告管理', '', '/adCoverConfig', 'el-icon-orange', '', 'menu', 1195, 1, '2021-12-01 17:12:17', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (1627, 1625, '直播间管理', '', '/liveMenu/liveRoom', 'el-icon-set-up', '', 'menu', 1196, 1, '2021-12-01 17:14:15', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (1628, 0, '广告管理', '', '/adCoverConfig', 'el-icon-orange', '', 'menu', 1197, 1, '2021-12-01 17:14:24', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (1629, 1625, '直播商品管理', '', '/liveMenu/liveProduct', 'el-icon-goods', '', 'menu', 1198, 1, '2021-12-01 17:15:02', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (1630, 0, '广告管理', '', '/ad', 'zk-icon-operation-plan2', '', 'catalog', 1199, 1, '2021-12-01 17:16:25', '2021-12-17 16:26:14');
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (1631, 1630, '广告管理', '', '/ad/coverConfig', 'el-icon-orange', '', 'menu', 1200, 1, '2021-12-01 17:17:35', '2021-12-01 17:35:24');
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (1632, 0, '风控管理', '', '/risk', 'zk-icon-finance-details', '', 'catalog', 1201, 1, '2021-12-01 18:51:54', '2021-12-17 16:26:29');
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (1685, 1632, 'IP黑名单', '', '/risk/IPBlacklist', 'el-icon-set-up', '', 'menu', 1220, 1, '2021-12-06 15:24:02', '2021-12-06 15:25:25');
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (1686, 1632, '用户黑名单', '', '/risk/userBlacklist', 'el-icon-set-up', '', 'menu', 1221, 1, '2021-12-06 15:30:26', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (1687, 1632, '风控规则', '', '/risk/riskRules', 'el-icon-set-up', '', 'menu', 1222, 1, '2021-12-06 15:31:36', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (1688, 0, '客服配置', '', '/customerService', 'el-icon-coordinate', '', 'menu', 1223, 1, '2021-12-06 17:17:11', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (1689, 0, '客服管理', '', '/customerService', 'el-icon-coordinate', '', 'button', 1224, 1, '2021-12-06 17:19:19', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (1690, 0, '客服配置', '', 'customerService', 'el-icon-coordinate', '', 'menu', 1225, 1, '2021-12-06 17:19:54', '2021-12-06 17:26:55');
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (1693, 0, '客服配置', '', 'customerService', 'el-icon-coordinate', '', 'menu', 1226, 1, '2021-12-06 17:28:33', '2021-12-08 14:55:07');
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (1697, 1696, '测试秒杀活动', '', '/active/seckill', 'el-icon-s-shop', '', 'menu', 1229, 1, '2021-12-07 15:56:49', '2021-12-07 16:05:10');
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (1698, 1696, '测试限时折扣', '', '/active/discount', 'el-icon-shopping-bag-1', '', 'menu', 1230, 1, '2021-12-07 16:03:33', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (1699, 1696, '测试支付有礼', '', '/active/polite', 'el-icon-bank-card', '', 'menu', 1231, 1, '2021-12-07 16:04:14', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (1700, 1696, '测试优惠卷', '', '/active/coupon', 'el-icon-s-ticket', '', 'menu', 1232, 1, '2021-12-07 16:04:51', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (1701, 0, '积分管理', '', '/integral', 'zk-icon-finance-details', '', 'catalog', 1000, 1, '2021-12-07 18:31:06', '2021-12-17 16:25:55');
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (1702, 1701, '积分配置', '', '/integral/configuration', 'el-icon-setting', '', 'menu', 1234, 1, '2021-12-07 18:33:49', '2021-12-07 18:48:54');
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (1703, 1701, '积分记录', '', '/integral/record', 'el-icon-date', '', 'menu', 1235, 1, '2021-12-07 18:34:25', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (1704, 1701, '签到天数配置', '', '/integral/signConfiguration', 'el-icon-edit', '', 'menu', 1236, 1, '2021-12-07 18:36:13', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (1706, 0, '客服配置', '', '/customerService', 'zk-icon-management-server', '客服配置', 'catalog', 1237, 1, '2021-12-08 14:57:02', '2021-12-17 16:26:39');
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (1707, 1706, '微信客服配置', '', '/customerService', 'el-icon-service', '微信客服配置', 'menu', 1238, 1, '2021-12-08 15:01:00', '2021-12-13 10:14:16');
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (2175, 68, '平台活动', '', '/active', 'el-icon-camera', '', 'menu', 1263, 0, '2021-12-23 17:34:48', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (2627, 0, '直播管理', '', '/liveMenu', 'el-icon-video-camera', '直播管理', 'catalog', 1264, 0, '2021-12-24 09:59:35', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (2628, 2627, '直播间管理', '', '/liveMenu/liveRoom', 'el-icon-set-up', '直播间管理', 'menu', 1265, 0, '2021-12-24 10:00:30', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (2629, 2627, '直播间商品管理', '', '/liveMenu/liveProduct', 'el-icon-shopping-bag-2', '直播间商品管理', 'menu', 1266, 0, '2021-12-24 10:01:22', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (2630, 0, '客服管理', '', '/customerService', 'el-icon-chat-round', '客服管理', 'catalog', 1267, 0, '2021-12-24 10:02:19', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (2631, 2630, '微信客服管理', '', '/customerService/service', 'el-icon-headset', '微信客服管理', 'menu', 1268, 0, '2021-12-24 10:03:18', NULL);
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (2633, 67, '分销员', '', '/distributor/index', 'el-icon-date', '', 'menu', 1270, 0, '2021-12-24 10:37:49', '2021-12-24 17:06:55');
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (3690, 707, '渠道优惠券管理', '', '/marketing/channelCoupons', 'el-icon-mobile-phone', '商家渠道优惠券', 'menu', 709, 0, '2021-12-27 09:32:34', '2021-12-27 18:39:55');
INSERT INTO `cere_platform_permission`(`permission_id`, `permission_pid`, `permission_name`, `permission_uri`, `permission`, `icon`, `describe`, `resource_type`, `sort`, `project`, `create_time`, `update_time`) VALUES (3723, 0, '测试', '', 'ceshi', 'el-icon-camera', '', 'menu', 1416, 1, '2021-12-27 19:05:53', NULL);
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=46 DEFAULT CHARSET=utf8mb4 COMMENT='平台支付有礼活动信息表';
...
CREATE TABLE `cere_platform_role` (
  ...
  `update_time` varchar(20) DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`role_id`)
) ENGINE=InnoDB AUTO_INCREMENT=64 DEFAULT CHARSET=utf8 COMMENT='角色信息表';
...
BEGIN;
INSERT INTO `cere_platform_role_permission`(`role_id`, `permission_id`) VALUES (1, 1);
INSERT INTO `cere_platform_role_permission`(`role_id`, `permission_id`) VALUES (1, 2);
INSERT INTO `cere_platform_role_permission`(`role_id`, `permission_id`) VALUES (1, 6);
INSERT INTO `cere_platform_role_permission`(`role_id`, `permission_id`) VALUES (1, 7);
INSERT INTO `cere_platform_role_permission`(`role_id`, `permission_id`) VALUES (1, 8);
INSERT INTO `cere_platform_role_permission`(`role_id`, `permission_id`) VALUES (1, 27);
INSERT INTO `cere_platform_role_permission`(`role_id`, `permission_id`) VALUES (1, 9);
INSERT INTO `cere_platform_role_permission`(`role_id`, `permission_id`) VALUES (1, 10);
INSERT INTO `cere_platform_role_permission`(`role_id`, `permission_id`) VALUES (1, 11);
INSERT INTO `cere_platform_role_permission`(`role_id`, `permission_id`) VALUES (1, 910);
INSERT INTO `cere_platform_role_permission`(`role_id`, `permission_id`) VALUES (1, 927);
INSERT INTO `cere_platform_role_permission`(`role_id`, `permission_id`) VALUES (1, 928);
INSERT INTO `cere_platform_role_permission`(`role_id`, `permission_id`) VALUES (1, 929);
INSERT INTO `cere_platform_role_permission`(`role_id`, `permission_id`) VALUES (1, 918);
INSERT INTO `cere_platform_role_permission`(`role_id`, `permission_id`) VALUES (1, 919);
INSERT INTO `cere_platform_role_permission`(`role_id`, `permission_id`) VALUES (1, 920);
INSERT INTO `cere_platform_role_permission`(`role_id`, `permission_id`) VALUES (1, 922);
INSERT INTO `cere_platform_role_permission`(`role_id`, `permission_id`) VALUES (1, 923);
INSERT INTO `cere_platform_role_permission`(`role_id`, `permission_id`) VALUES (1, 924);
INSERT INTO `cere_platform_role_permission`(`role_id`, `permission_id`) VALUES (1, 24);
INSERT INTO `cere_platform_role_permission`(`role_id`, `permission_id`) VALUES (1, 25);
INSERT INTO `cere_platform_role_permission`(`role_id`, `permission_id`) VALUES (1, 26);
INSERT INTO `cere_platform_role_permission`(`role_id`, `permission_id`) VALUES (1, 48);
INSERT INTO `cere_platform_role_permission`(`role_id`, `permission_id`) VALUES (1, 914);
INSERT INTO `cere_platform_role_permission`(`role_id`, `permission_id`) VALUES (1, 915);
INSERT INTO `cere_platform_role_permission`(`role_id`, `permission_id`) VALUES (1, 916);
INSERT INTO `cere_platform_role_permission`(`role_id`, `permission_id`) VALUES (1, 911);
INSERT INTO `cere_platform_role_permission`(`role_id`, `permission_id`) VALUES (1, 34);
INSERT INTO `cere_platform_role_permission`(`role_id`, `permission_id`) VALUES (1, 1201);
INSERT INTO `cere_platform_role_permission`(`role_id`, `permission_id`) VALUES (1, 37);
INSERT INTO `cere_platform_role_permission`(`role_id`, `permission_id`) VALUES (1, 38);
INSERT INTO `cere_platform_role_permission`(`role_id`, `permission_id`) VALUES (1, 39);
INSERT INTO `cere_platform_role_permission`(`role_id`, `permission_id`) VALUES (1, 40);
INSERT INTO `cere_platform_role_permission`(`role_id`, `permission_id`) VALUES (1, 74);
INSERT INTO `cere_platform_role_permission`(`role_id`, `permission_id`) VALUES (1, 75);
INSERT INTO `cere_platform_role_permission`(`role_id`, `permission_id`) VALUES (1, 76);
INSERT INTO `cere_platform_role_permission`(`role_id`, `permission_id`) VALUES (1, 77);
INSERT INTO `cere_platform_role_permission`(`role_id`, `permission_id`) VALUES (1, 78);
INSERT INTO `cere_platform_role_permission`(`role_id`, `permission_id`) VALUES (1, 496);
INSERT INTO `cere_platform_role_permission`(`role_id`, `permission_id`) VALUES (1, 578);
INSERT INTO `cere_platform_role_permission`(`role_id`, `permission_id`) VALUES (1, 579);
INSERT INTO `cere_platform_role_permission`(`role_id`, `permission_id`) VALUES (1, 580);
INSERT INTO `cere_platform_role_permission`(`role_id`, `permission_id`) VALUES (1, 1701);
INSERT INTO `cere_platform_role_permission`(`role_id`, `permission_id`) VALUES (1, 1702);
INSERT INTO `cere_platform_role_permission`(`role_id`, `permission_id`) VALUES (1, 1703);
INSERT INTO `cere_platform_role_permission`(`role_id`, `permission_id`) VALUES (1, 1704);
INSERT INTO `cere_platform_role_permission`(`role_id`, `permission_id`) VALUES (1, 1625);
INSERT INTO `cere_platform_role_permission`(`role_id`, `permission_id`) VALUES (1, 1627);
INSERT INTO `cere_platform_role_permission`(`role_id`, `permission_id`) VALUES (1, 1629);
INSERT INTO `cere_platform_role_permission`(`role_id`, `permission_id`) VALUES (1, 1630);
INSERT INTO `cere_platform_role_permission`(`role_id`, `permission_id`) VALUES (1, 1631);
INSERT INTO `cere_platform_role_permission`(`role_id`, `permission_id`) VALUES (1, 1632);
INSERT INTO `cere_platform_role_permission`(`role_id`, `permission_id`) VALUES (1, 1685);
INSERT INTO `cere_platform_role_permission`(`role_id`, `permission_id`) VALUES (1, 1686);
INSERT INTO `cere_platform_role_permission`(`role_id`, `permission_id`) VALUES (1, 1687);
INSERT INTO `cere_platform_role_permission`(`role_id`, `permission_id`) VALUES (1, 1697);
INSERT INTO `cere_platform_role_permission`(`role_id`, `permission_id`) VALUES (1, 1698);
INSERT INTO `cere_platform_role_permission`(`role_id`, `permission_id`) VALUES (1, 1699);
INSERT INTO `cere_platform_role_permission`(`role_id`, `permission_id`) VALUES (1, 1700);
INSERT INTO `cere_platform_role_permission`(`role_id`, `permission_id`) VALUES (1, 3);
INSERT INTO `cere_platform_role_permission`(`role_id`, `permission_id`) VALUES (1, 4);
INSERT INTO `cere_platform_role_permission`(`role_id`, `permission_id`) VALUES (1, 5);
INSERT INTO `cere_platform_role_permission`(`role_id`, `permission_id`) VALUES (1, 33);
INSERT INTO `cere_platform_role_permission`(`role_id`, `permission_id`) VALUES (1, 911);
INSERT INTO `cere_platform_role_permission`(`role_id`, `permission_id`) VALUES (1, 914);
INSERT INTO `cere_platform_role_permission`(`role_id`, `permission_id`) VALUES (1, 916);
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=107 DEFAULT CHARSET=utf8 COMMENT='平台秒杀活动信息表';
...
CREATE TABLE `cere_platform_sensitive` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='敏感词库信息表';
...
CREATE TABLE `cere_platform_shop` (
  ...
  `create_time` varchar(20) DEFAULT NULL COMMENT '创建时间',
  `update_time` varchar(20) DEFAULT NULL COMMENT '更新时间',
  `divide` int(10) DEFAULT NULL COMMENT '交易分成比例',
  `collection_code` varchar(255) DEFAULT NULL COMMENT '平台收款码',
  `audit_live` tinyint(1) DEFAULT '1' COMMENT '审核直播间 1-开启 0-关闭',
  `audit_live_product` tinyint(1) DEFAULT '1' COMMENT '审核直播间商品 1-开启 0-关闭',
  PRIMARY KEY (`shop_id`)
) ENGINE=InnoDB AUTO_INCREMENT=186 DEFAULT CHARSET=utf8 COMMENT='商家信息表';
...
CREATE TABLE `cere_platform_user` (
  ...
  `token` varchar(128) DEFAULT NULL COMMENT '账户token',
  `state` tinyint(1) NOT NULL COMMENT '是否启用   1-是 0-否',
  `create_time` varchar(20) DEFAULT NULL COMMENT '创建时间',
  `update_time` varchar(20) DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`platform_user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=38 DEFAULT CHARSET=utf8 COMMENT='平台账户信息表';

BEGIN;
INSERT INTO `cere_platform_user` VALUES (2, 'admin', '大权限账号', '男', '1234567890', 'CNJmcGxnwmM=', '', '', 1, '2020-12-23 19:10:56', '2021-01-14 00:18:48');
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=100 DEFAULT CHARSET=utf8mb4 COMMENT='接口请求记录表';
...
CREATE TABLE `cere_popup_advert` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键id',
  `name` varchar(64) COLLATE utf8mb4_bin NOT NULL DEFAULT '' COMMENT '广告名称',
  `start_time` varchar(32) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '开始时间',
  `end_time` varchar(32) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '结束时间',
  `popup_img` varchar(256) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '弹窗广告图片',
  `close_img` varchar(256) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '关闭图片',
  `jump_type` int(11) NOT NULL COMMENT '跳转类型 1-商品 2-分类 3-优惠券 4-小程序 5-公众号文章',
  `jump_content` varchar(8192) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '跳转内容，根据jump_type不同存储不同的内容',
  ...
  `create_time` varchar(32) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '创建时间',
  `update_time` varchar(32) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='弹窗广告表';
...
) ENGINE=InnoDB AUTO_INCREMENT=119 DEFAULT CHARSET=utf8mb4 COMMENT='商品提问回答信息表';
...
) ENGINE=InnoDB AUTO_INCREMENT=822 DEFAULT CHARSET=utf8 COMMENT='商品分类信息表';
...
) ENGINE=InnoDB AUTO_INCREMENT=195 DEFAULT CHARSET=utf8mb4 COMMENT='商品提问信息表';
...
) ENGINE=InnoDB AUTO_INCREMENT=2101 DEFAULT CHARSET=utf8 COMMENT='商品规格信息表';
...
CREATE TABLE `cere_risk_black` (
  ...
  `buyer_user_id` bigint(20) DEFAULT NULL COMMENT '用户id',
  `state` tinyint(1) DEFAULT '1' COMMENT '是否有效，0否 1是',
  `create_time` varchar(20) NOT NULL COMMENT '创建时间',
  `update_time` varchar(20) NOT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=30 DEFAULT CHARSET=utf8mb4 COMMENT='黑名单表';
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COMMENT='风控规则表';
...
CREATE TABLE `cere_shop_cart` (
  ...
  `update_time` varchar(20) DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`cart_id`)
) ENGINE=InnoDB AUTO_INCREMENT=1717 DEFAULT CHARSET=utf8 COMMENT='购物车信息表';
...
) ENGINE=InnoDB AUTO_INCREMENT=81 DEFAULT CHARSET=utf8 COMMENT='店铺入驻处理信息表';
...
) ENGINE=InnoDB AUTO_INCREMENT=109 DEFAULT CHARSET=utf8mb4 COMMENT='客户评论信息表';
...
) ENGINE=InnoDB AUTO_INCREMENT=58 DEFAULT CHARSET=utf8mb4 COMMENT='商家组合捆绑信息表';
...
) ENGINE=InnoDB AUTO_INCREMENT=173 DEFAULT CHARSET=utf8 COMMENT='店铺优惠券信息表';
...
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='客户分群信息表';
...
) ENGINE=InnoDB AUTO_INCREMENT=39 DEFAULT CHARSET=utf8 COMMENT='店铺限时折扣活动信息表';
...
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8 COMMENT='店铺分销员等级信息表';
...
) ENGINE=InnoDB AUTO_INCREMENT=53 DEFAULT CHARSET=utf8 COMMENT='分销员信息表';
...
) ENGINE=InnoDB AUTO_INCREMENT=145 DEFAULT CHARSET=utf8 COMMENT='店铺商品分组信息表';
...
) ENGINE=InnoDB AUTO_INCREMENT=98 DEFAULT CHARSET=utf8 COMMENT='店铺拼团活动信息表';
...
CREATE TABLE `cere_shop_label` (
  ...
  `label_type` tinyint(2) DEFAULT '1' COMMENT '标签类型 1-图片 2-视频',
  `create_time` varchar(20) DEFAULT NULL COMMENT '创建时间',
  `update_time` varchar(20) DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`label_id`)
) ENGINE=InnoDB AUTO_INCREMENT=55 DEFAULT CHARSET=utf8 COMMENT='店铺标签信息表';
...
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 COMMENT='店铺运营计划信息表';
...
CREATE TABLE `cere_shop_order` (
  ...
  `type` tinyint(1) DEFAULT NULL COMMENT '类型 1-常规订单 2-商家收款订单（扫码）',
  `write_state` tinyint(1) DEFAULT NULL COMMENT '核销状态  0-无需核销 1-部分核销 2-已核销',
  PRIMARY KEY (`order_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2633 DEFAULT CHARSET=utf8 COMMENT='订单信息表';
...
) ENGINE=InnoDB AUTO_INCREMENT=38 DEFAULT CHARSET=utf8mb4 COMMENT='商家定价捆绑信息表';
...
CREATE TABLE `cere_shop_product` (
  ...
  `distribution` tinyint(1) DEFAULT NULL COMMENT '配送属性 1-线下核销 2-快递',
  `if_gift` tinyint(1) DEFAULT NULL COMMENT '是否参与赠品 1-是 0-否',
  `if_credit` tinyint(1) DEFAULT '0' COMMENT '是否积分抵扣 1-是 0-否',
  `credit_limit` int(11) DEFAULT NULL COMMENT '单笔最大抵扣多少积分',
  PRIMARY KEY (`product_id`),
  UNIQUE KEY `index` (`product_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=601 DEFAULT CHARSET=utf8 COMMENT='店铺商品信息表';
...
) ENGINE=InnoDB AUTO_INCREMENT=84 DEFAULT CHARSET=utf8mb4 COMMENT='场景营销信息表';
...
) ENGINE=InnoDB AUTO_INCREMENT=59 DEFAULT CHARSET=utf8 COMMENT='店铺秒杀活动信息表';
...
CREATE TABLE `cere_shop_user_label` (
  ...
  `update_time` varchar(20) DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`label_id`)
) ENGINE=InnoDB AUTO_INCREMENT=52 DEFAULT CHARSET=utf8 COMMENT='店铺用户标签信息表';
...
CREATE TABLE `cere_shop_withdrawal` (
  ...
  PRIMARY KEY (`withdrawal_id`)
) ENGINE=InnoDB AUTO_INCREMENT=28 DEFAULT CHARSET=utf8 COMMENT='商家提现申请信息表';
