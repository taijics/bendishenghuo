/*
 ...
 Source Schema         : cereshop3.2

 Target Server Type    : MySQL
 Target Server Version : 80200
 File Encoding         : 65001

 Date: 17/11/2024 21:19:59
*/
...
CREATE TABLE `cere_activity_sign`  (
  `sign_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '报名id',
  `sign_code` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '交易流水号',
  `shop_id` bigint(0) NOT NULL COMMENT '关联店铺id',
  `activity_id` bigint(0) NOT NULL COMMENT '关联活动id',
  `bond_money` decimal(15, 2) NULL DEFAULT NULL COMMENT '保证金',
  `payment_mode` tinyint(1) NULL DEFAULT 1 COMMENT '支付方式  1-微信支付 2-支付宝支付',
  `qr_image` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '收款二维码',
  ...
  `payment_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '缴纳时间',
  `return_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '退保时间',
  `remark` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '审核备注',
  ...
  `update_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`sign_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 406 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '商家报名活动申请信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_after_dilever`  (
  ...
  `after_id` bigint(0) NULL DEFAULT NULL COMMENT '关联售后单id',
  `express` bigint(0) NOT NULL COMMENT '快递公司（取数据字典）',
  `deliver_formid` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '快递单号',
  `reason` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '说明',
  `image` varchar(500) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '凭证图片，多个以逗号隔开',
  `create_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '更新时间'
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '买家退货信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_after_product`  (
  `after_product_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '售后单商品明细id',
  `after_id` bigint(0) NOT NULL COMMENT '关联售后单id',
  `product_id` bigint(0) NOT NULL COMMENT '关联商品id',
  `sku_id` bigint(0) NOT NULL COMMENT '关联规格id',
  `product_name` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '商品名称',
  `number` int(0) NOT NULL COMMENT '购买数量',
  `product_price` decimal(15, 2) NOT NULL COMMENT '商品售价',
  `image` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '图片地址',
  `SKU` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT 'SKU',
  `weight` decimal(15, 2) NULL DEFAULT NULL COMMENT '重量',
  PRIMARY KEY (`after_product_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1115 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '售后单商品信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_after_product_attribute`  (
  `after_product_id` bigint(0) NOT NULL COMMENT '关联售后商品明细id',
  `sku_name` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '规格名',
  `sku_value` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '规格值',
  `name_code` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '规格名级别',
  `value_code` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '规格值级别'
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '售后商品属性信息表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '品牌表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_business_buyer_user`  (
  ...
  `buyer_user_id` bigint(0) NOT NULL COMMENT '用户id',
  `create_time` varchar(20) CHARACTER SET utf8mb4 NOT NULL COMMENT '创建时间(首次成为客户时间)',
  `update_time` varchar(20) CHARACTER SET utf8mb4 NULL DEFAULT NULL COMMENT '更新时间(上次消费时间)',
  PRIMARY KEY (`shop_id`, `buyer_user_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COMMENT = '商家客户关联表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_business_shop`  (
  `business_user_id` bigint(0) NOT NULL COMMENT '商家用户id',
  `shop_id` bigint(0) NOT NULL COMMENT '店铺id',
  `if_binding` tinyint(1) NOT NULL COMMENT '是否绑定当前店铺 1-是 0-否'
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '商家用户绑定店铺信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_business_user_role`  (
  `business_user_id` bigint(0) NOT NULL COMMENT '商家用户id',
  `role_id` bigint(0) NOT NULL COMMENT '关联角色表id'
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '商家用户关联角色表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_buyer_bank`  (
  `bank_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '银行卡id',
  `buyer_user_id` bigint(0) NOT NULL COMMENT '客户id',
  ...
  `bank_name` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '银行名称',
  `bank_card` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '卡号',
  PRIMARY KEY (`bank_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 701 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '客户绑定银行卡信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_buyer_collect`  (
  `collect_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '收藏id',
  `buyer_user_id` bigint(0) NOT NULL COMMENT '客户id',
...
) ENGINE = InnoDB AUTO_INCREMENT = 1322 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '客户收藏信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_buyer_comment_like`  (
  ...
  `buyer_user_id` bigint(0) NOT NULL COMMENT '点赞客户id',
  `if_like` tinyint(1) NOT NULL DEFAULT 0 COMMENT '是否点赞 1-是 0-否',
  PRIMARY KEY (`comment_id`, `buyer_user_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '客户评论点赞信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_buyer_coupon`  (
  ...
  `buyer_user_id` bigint(0) NOT NULL COMMENT '客户id',
  `activity_id` bigint(0) NOT NULL COMMENT '平台活动id',
  `activity_name` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '活动名称',
  `start_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '活动开始时间',
  `end_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '活动结束时间',
  ...
  `source` int(0) NOT NULL DEFAULT 1 COMMENT '来源 1-正常领取 2-营销发券 3-积分兑换 4-支付有礼',
  `coupon_code` varchar(128) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '微信卡券的coupon_code',
  `create_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 11396598745982 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '客户关联优惠券信息实体类' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_buyer_discount_visit`  (
  `shop_discount_id` bigint(0) NOT NULL COMMENT '限时折扣活动id',
  `buyer_user_id` bigint(0) NOT NULL COMMENT '浏览客户id',
  `visit_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '浏览时间'
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '客户浏览限时折扣记录表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_buyer_footprint`  (
  `footprint_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '足迹id',
  `shop_id` bigint(0) NOT NULL COMMENT '店铺id',
  `product_id` bigint(0) NOT NULL COMMENT '商品id',
  `sku_id` bigint(0) NOT NULL COMMENT '规格id',
  `buyer_user_id` bigint(0) NOT NULL COMMENT '客户id',
  `selected` tinyint(1) NULL DEFAULT NULL COMMENT '是否选中 1-是 0-否',
...
) ENGINE = InnoDB AUTO_INCREMENT = 45562 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '商品足迹信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_buyer_label`  (
  `buyer_user_id` bigint(0) NOT NULL COMMENT '关联客户id',
  `buyer_label_id` bigint(0) NOT NULL COMMENT '关联平台标签id'
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '客户关联标签信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_buyer_notice`  (
  `notice_id` bigint(0) NOT NULL COMMENT '消息id',
  `buyer_user_id` bigint(0) NOT NULL COMMENT '客户id',
  `status` int(0) NOT NULL DEFAULT 0 COMMENT '0-未删除 1-已删除 主要针对系统公告和站内信使用'
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COMMENT = '客户已读公告、站内信消息关系表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_buyer_platform_discount_visit`  (
  `discount_id` bigint(0) NOT NULL COMMENT '平台限时折扣活动id',
  `buyer_user_id` bigint(0) NOT NULL COMMENT '浏览客户id',
  `visit_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '浏览时间',
  `shop_id` bigint(0) NOT NULL COMMENT '店铺id'
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '客户浏览平台限时折扣记录表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_buyer_platform_seckill_visit`  (
  `seckill_id` bigint(0) NOT NULL COMMENT '平台秒杀活动id',
  `buyer_user_id` bigint(0) NOT NULL COMMENT '浏览客户id',
  `visit_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '浏览时间',
  `shop_id` bigint(0) NOT NULL COMMENT '店铺id'
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '客户浏览平台秒杀记录表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_buyer_polite_record`  (
  ...
  `buyer_user_id` bigint(0) NOT NULL COMMENT '用户id',
  `order_id` bigint(0) NOT NULL COMMENT '关联订单id',
  `polite_id` bigint(0) NOT NULL COMMENT '关联的支付有礼活动id',
  `polite_type` tinyint(0) NOT NULL COMMENT '奖励类型 1-成长值，2-满减券，3-折扣券, 4-积分',
  `growth` int(0) UNSIGNED NOT NULL DEFAULT 0 COMMENT '奖励的成长值',
  `credit` int(0) NOT NULL DEFAULT 0 COMMENT '奖励的积分',
  `discount` decimal(15, 2) NOT NULL DEFAULT 0.00 COMMENT '奖励的优惠券金额，或折扣券的折扣额度',
  `create_time` varchar(20) CHARACTER SET utf8mb4 NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` varchar(20) CHARACTER SET utf8mb4 NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_buyer_user_id`(`buyer_user_id`) USING BTREE,
  INDEX `idx_order_id`(`order_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1476600540083081363 CHARACTER SET = utf8mb4 COMMENT = '用户支付有礼记录' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for cere_buyer_product_record
-- ----------------------------
DROP TABLE IF EXISTS `cere_buyer_product_record`;
CREATE TABLE `cere_buyer_product_record`  (
  `buyer_user_id` bigint(0) NOT NULL COMMENT '用户id',
  `product_id` bigint(0) NOT NULL COMMENT '商品id',
  `create_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  PRIMARY KEY (`buyer_user_id`, `product_id`) USING BTREE,
  INDEX `idx_create_time`(`create_time`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '用户购买过某商品的记录' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_buyer_receive`  (
  `receive_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '收货地址id',
  `buyer_user_id` bigint(0) NOT NULL COMMENT '关联客户id',
  `receive_name` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '收货人姓名',
  `receive_phone` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '收货人电话',
  `receive_adress` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '收货地址',
  `address` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '详细地址',
  `label` varchar(5) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '地址标签 家、公司、学校',
  `if_default` tinyint(1) NOT NULL DEFAULT 0 COMMENT '是否默认 1-是 0-否',
  `create_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`receive_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4838 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '客户收货地址信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_buyer_search`  (
  `search_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '搜索id',
  `buyer_user_id` bigint(0) NOT NULL COMMENT '客户id',
  `search` varchar(40) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '搜索内容',
  PRIMARY KEY (`search_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2999 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '客户历史搜索信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_buyer_seckill_visit`  (
  `shop_seckill_id` bigint(0) NOT NULL COMMENT '秒杀活动id',
  `buyer_user_id` bigint(0) NOT NULL COMMENT '浏览客户id',
  `visit_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '浏览时间'
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '客户浏览秒杀记录表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_buyer_shop_coupon`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '主键id',
  `shop_operate_id` bigint(0) NULL DEFAULT NULL COMMENT '运营计划id',
  `shop_coupon_id` bigint(0) NOT NULL COMMENT '商家优惠券id',
  `buyer_user_id` bigint(0) NOT NULL COMMENT '客户id',
  `coupon_name` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '优惠券名称',
  `start_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '用券开始时间',
  `end_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '用券结束时间',
  ...
  `update_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 38638 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '客户关联商家优惠券信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_buyer_shop_label`  (
  `buyer_user_id` bigint(0) NOT NULL COMMENT '关联客户id',
  `label_id` bigint(0) NOT NULL COMMENT '关联商家标签id'
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '客户关联商家标签信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_buyer_track_report`  (
  ...
  `event_type` int(0) NOT NULL DEFAULT 1 COMMENT '事件类型 1-商品详情页访问5s, 2-添加到购物车, 3-提交订单',
...
) ENGINE = InnoDB AUTO_INCREMENT = 14267 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '用户埋点上报' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_buyer_user`  (
  `buyer_user_id` bigint(0) NOT NULL AUTO_INCREMENT,
  ...
  `birthday` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '生日',
  `wechat_open_id` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '微信openID',
  `wechat_union_id` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '微信unionId',
  `wechat_name` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '微信昵称',
  `wechat_number` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '微信号',
  `ali_user_id` varchar(50) CHARACTER SET utf8mb4 NULL DEFAULT NULL COMMENT '支付宝小程序用户id',
  `phone` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '注册手机号',
  `password` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '密码',
  `head_image` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '头像图片',
  ...
  `token` varchar(128) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '请求token',
  `member_level_id` bigint(0) NULL DEFAULT NULL COMMENT '会员等级id',
  `growth` int(0) NULL DEFAULT 0 COMMENT '成长值',
  `credit` int(0) NOT NULL DEFAULT 0 COMMENT '积分值',
  `terminal` int(0) NOT NULL COMMENT '注册来源 0-未知 1-APP 2-微信小程序 3-H5 4-支付宝小程序 5-PC 6-商家端后台',
  `register_ip` varchar(128) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '注册时的ip',
  `last_login_ip` varchar(128) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '最近一次登录时的ip',
  `channel_code` varchar(32) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '渠道编码',
  `create_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`buyer_user_id`) USING BTREE,
  UNIQUE INDEX `index`(`phone`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 8324 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '客户信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_buyer_withdrawal`  (
  `withdrawal_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '提现申请id',
  `buyer_user_id` bigint(0) NOT NULL COMMENT '客户id',
  `bank_name` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '银行名称',
  `bank_card` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '银行卡号',
  `withdrawal_money` decimal(15, 2) NOT NULL COMMENT '提现金额',
  `state` tinyint(1) NOT NULL DEFAULT 0 COMMENT '处理状态  0-审核中 1-通过 2-拒绝',
  `apply_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '申请时间',
  `handle_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '处理时间',
  PRIMARY KEY (`withdrawal_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '客户提现信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_cart_attribute`  (
  `cart_id` bigint(0) NOT NULL COMMENT '关联购物车id',
  `sku_name` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '规格名',
  `sku_value` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '规格值',
  `name_code` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '规格名级别',
  `value_code` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '规格值级别'
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '购物车商品属性表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_channel`  (
  ...
  `update_time` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '渠道表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_channel_coupon`  (
  `shop_coupon_id` bigint(0) NOT NULL COMMENT '优惠券id',
  `product_id` bigint(0) NOT NULL COMMENT '商品id',
  `shop_id` bigint(0) NOT NULL COMMENT '店铺id',
  `create_time` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '创建时间',
  `update_time` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '更新时间',
...
CREATE TABLE `cere_city_manage`  (
  ...
  `city_pid` bigint(0) NOT NULL COMMENT '上级节点id',
  `city_name` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '城市名称',
  `create_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`city_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 820001 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '城市管理信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_close_advert`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '主键id',
  `buyer_user_id` bigint(0) NULL DEFAULT NULL COMMENT '用户id',
  `device_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '设备id',
  `trigger_condition` int(0) NOT NULL DEFAULT 1 COMMENT '触发页面 1-首页 2-支付完成页',
...
) ENGINE = InnoDB AUTO_INCREMENT = 885 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '关闭广告记录表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_collage_order`  (
  `collage_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '拼团单id',
  `shop_group_work_id` bigint(0) NOT NULL COMMENT '拼团活动id',
  `state` tinyint(1) NOT NULL COMMENT '拼单状态，0-待成团，1-拼团成功，2-拼团失败',
  `collage_name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '拼团名称',
  `buyer_user_id` bigint(0) NULL DEFAULT NULL COMMENT '发起人用户ID',
  `surplus_number` int(0) NULL DEFAULT NULL COMMENT '剩余人数',
  `create_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`collage_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 920 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '拼单信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_collage_order_detail`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT,
  `collage_id` bigint(0) NOT NULL COMMENT '拼团单id',
...
) ENGINE = InnoDB AUTO_INCREMENT = 1015 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '拼单关联订单信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_comment_word`  (
  `comment_id` bigint(0) NOT NULL COMMENT '评论id',
  `product_id` bigint(0) NOT NULL COMMENT '商品id',
  `word_id` bigint(0) NOT NULL COMMENT '关键词id',
  `key_word` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '关键词'
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '关键词关联评论信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_compose_product`  (
  `compose_id` bigint(0) NOT NULL COMMENT '组合捆绑id',
  `product_id` bigint(0) NOT NULL COMMENT '商品id'
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COMMENT = '商家组合捆绑商品信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_credit_record`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '主键id',
  `buyer_user_id` bigint(0) NOT NULL COMMENT '用户id',
  `record_type` int(0) NOT NULL DEFAULT 1 COMMENT '流水类型 1-收入 2-支出',
  `opt_type` int(0) NOT NULL DEFAULT 0 COMMENT '操作类型 参考OptTypeEnum',
  `record_content` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '' COMMENT '操作描述',
  `credit` int(0) NOT NULL DEFAULT 0 COMMENT '本次收入或支出积分',
  `remain_credit` int(0) NOT NULL DEFAULT 0 COMMENT '剩余积分',
  `create_time` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '创建时间',
...
) ENGINE = InnoDB AUTO_INCREMENT = 2769 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '积分流水表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_credit_sign_setting`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '主键id',
  `day` int(0) NOT NULL DEFAULT 1 COMMENT '第几天',
  `credit` int(0) NOT NULL DEFAULT 0 COMMENT '赠送积分值',
  `display` int(0) NOT NULL DEFAULT 1 COMMENT '是否显示 1-是 0-否',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 15 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '积分签到配置' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_credit_signin_record`  (
  ...
  `buyer_user_id` bigint(0) NOT NULL COMMENT '客户id',
  `term_id` int(0) NOT NULL DEFAULT 1 COMMENT '轮询id,第一天签到则为1，第2天签到则为2，连续签到值越来越大',
  `continue_day` int(0) NOT NULL DEFAULT 1 COMMENT '连续第几天签到',
  `credit` int(0) NOT NULL DEFAULT 10 COMMENT '奖励的积分',
  `create_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_buyer_user_id`(`buyer_user_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1087 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '积分签到表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 15 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '商家客服配置表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_distribution_order`  (
  `order_id` bigint(0) NOT NULL COMMENT '关联订单id',
  `order_formid` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '订单编号',
  `distributor_id` bigint(0) NOT NULL COMMENT '关联分销员id',
  `distributor_name` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '分销员名称',
  `distributor_phone` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '分销员手机号',
  ...
  `transaction_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '交易时间',
  `type` tinyint(1) NOT NULL DEFAULT 1 COMMENT '佣金类型 1-直接佣金 2-间接佣金'
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '分销员订单信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_distributor_buyer`  (
  ...
  `update_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '关系更新时间',
  PRIMARY KEY (`distributor_id`, `buyer_user_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '分销员绑定客户信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_label_attribute`  (
  `label_id` bigint(0) NOT NULL COMMENT '关联标签id',
  `image` varchar(500) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '图片地址',
  `link` varchar(500) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '链接'
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '店铺标签属性表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_label_source`  (
  `label_id` bigint(0) NOT NULL COMMENT '店铺标签id',
  `label_type` tinyint(1) NULL DEFAULT NULL COMMENT '素材类型 1-图片 2-视频',
  `image` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '图片地址',
  `link` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '链接'
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '店铺素材信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_live`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '主键id',
  `shop_id` bigint(0) NOT NULL COMMENT '店铺id',
  `title` varchar(32) CHARACTER SET utf8mb4 NOT NULL DEFAULT '' COMMENT '标题',
  `anchor_nickname` varchar(32) CHARACTER SET utf8mb4 NULL DEFAULT '' COMMENT '主播昵称',
  `anchor_wechat` varchar(32) CHARACTER SET utf8mb4 NULL DEFAULT NULL COMMENT '主播微信号',
  `anchor_head_img` varchar(256) CHARACTER SET utf8mb4 NULL DEFAULT NULL COMMENT '主播头像',
  `live_type` int(0) NULL DEFAULT NULL COMMENT '直播间类型 0-手机直播 1-推流',
  `screen_type` int(0) NULL DEFAULT NULL COMMENT '屏幕方向 0-竖屏 1-横屏',
  `close_like` int(0) NULL DEFAULT NULL COMMENT '是否关闭点赞',
  `close_goods_shelf` int(0) NULL DEFAULT NULL COMMENT '是否关闭商品上架',
  `close_comment` int(0) NULL DEFAULT NULL COMMENT '是否关闭评论',
  `close_playback` int(0) NULL DEFAULT NULL COMMENT '是否关闭回放',
  `close_share` int(0) NULL DEFAULT NULL COMMENT '是否关闭分享',
  `close_service` int(0) NULL DEFAULT NULL COMMENT '是否关闭客服',
  `close_appointment` int(0) NULL DEFAULT NULL COMMENT '是否关闭直播预约',
  `start_time` varchar(32) CHARACTER SET utf8mb4 NULL DEFAULT NULL COMMENT '开始时间',
  `end_time` varchar(32) CHARACTER SET utf8mb4 NULL DEFAULT NULL COMMENT '结束时间',
  `cover_img` varchar(256) CHARACTER SET utf8mb4 NULL DEFAULT NULL COMMENT '直播间背景图',
  `share_img` varchar(256) CHARACTER SET utf8mb4 NULL DEFAULT NULL COMMENT '直播间分享图片',
  `feeds_img` varchar(256) CHARACTER SET utf8mb4 NULL DEFAULT NULL COMMENT '封面图',
  `cover_media_id` varchar(256) CHARACTER SET utf8mb4 NULL DEFAULT NULL COMMENT '背景图媒体id',
  `share_media_id` varchar(256) CHARACTER SET utf8mb4 NULL DEFAULT NULL COMMENT '分享图媒体id',
  `feeds_media_id` varchar(256) CHARACTER SET utf8mb4 NULL DEFAULT NULL COMMENT '封面图媒体id',
  `room_id` int(0) NULL DEFAULT NULL COMMENT '微信端-直播间id',
  `state` int(0) NULL DEFAULT NULL COMMENT '状态: 0 - 待审核 1 - 审核已通过 2 - 审核未通过',
  `remark` varchar(32) CHARACTER SET utf8mb4 NULL DEFAULT NULL COMMENT '审核备注',
  `create_time` varchar(32) CHARACTER SET utf8mb4 NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` varchar(32) CHARACTER SET utf8mb4 NULL DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 148 CHARACTER SET = utf8mb4 COMMENT = '直播表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_live_examine`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT,
  `live_id` bigint(0) NOT NULL COMMENT '直播间id',
  `re_examine_date` date NOT NULL COMMENT '重新审核日期',
  `create_time` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '创建时间',
  `update_time` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '更新时间',
  INDEX `id`(`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 31 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '直播间重新审核表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_live_product`  (
  ...
  `shop_id` bigint(0) NOT NULL COMMENT '店铺id',
  `product_id` bigint(0) NOT NULL COMMENT '商品id',
  `goods_id` int(0) NULL DEFAULT NULL COMMENT '微信直播商品id',
  `product_name` varchar(32) CHARACTER SET utf8mb4 NULL DEFAULT NULL COMMENT '商品名称',
  `product_image` varchar(256) CHARACTER SET utf8mb4 NULL DEFAULT NULL COMMENT '商品封面图',
  `product_image_media_id` varchar(256) CHARACTER SET utf8mb4 NULL DEFAULT NULL COMMENT '商品封面图媒体id',
  `price_type` int(0) NOT NULL COMMENT '价格类型 1- 一口价 2-价格区间 3-折扣价',
  ...
  `stock_number` int(0) NOT NULL DEFAULT 0 COMMENT '商品库存',
  `total` int(0) NOT NULL COMMENT '商品初始库存',
  `state` int(0) NULL DEFAULT NULL COMMENT '状态 0-待审核 1-审核通过 2-审核失败',
  `remark` varchar(32) CHARACTER SET utf8mb4 NULL DEFAULT NULL COMMENT '备注',
  `create_time` varchar(32) CHARACTER SET utf8mb4 NOT NULL COMMENT '创建时间',
  `update_time` varchar(32) CHARACTER SET utf8mb4 NOT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 80 CHARACTER SET = utf8mb4 COMMENT = '直播间商品表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_live_product_examine`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT,
  `live_product_id` bigint(0) NOT NULL COMMENT '直播商品id',
  `re_examine_date` date NOT NULL COMMENT '重新审核日期',
  `create_time` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '创建时间',
  `update_time` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '更新时间',
  INDEX `id`(`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '直播间商品重新审核表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_live_product_rel`  (
  `live_id` bigint(0) NOT NULL COMMENT '直播间id',
  `live_product_id` bigint(0) NOT NULL COMMENT '直播间商品id, 关联cere_live_product的id',
  `create_time` varchar(32) CHARACTER SET utf8mb4 NOT NULL COMMENT '创建时间',
  `update_time` varchar(32) CHARACTER SET utf8mb4 NOT NULL COMMENT '修改时间',
  PRIMARY KEY (`live_id`, `live_product_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COMMENT = '直播间和直播间商品的关联表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_live_sale_stat`  (
  `product_id` bigint(0) NOT NULL COMMENT '商品id',
  `sale_number` int(0) NOT NULL DEFAULT 0 COMMENT '直播销量',
  `sale_amount` decimal(10, 2) NOT NULL COMMENT '直播销售额',
  PRIMARY KEY (`product_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COMMENT = '直播商品销售统计' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_live_subscribe`  (
  ...
  `update_time` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 40 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '直播订阅表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_logistics_charge`  (
  `logistics_id` bigint(0) NOT NULL COMMENT '关联物流方案id',
  `region` text CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '配送区域 省-市',
...
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '物流计费明细信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_member_signin_record`  (
  `signin_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '签到id',
  `buyer_user_id` bigint(0) NOT NULL COMMENT '客户id',
  `term_id` int(0) NOT NULL DEFAULT 1 COMMENT '轮询id,第一天签到则为1，第2天签到则为2，到7之后，从1重新开始',
  `growth` int(0) NOT NULL DEFAULT 10 COMMENT '奖励的成长值',
  `create_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`signin_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 191 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '会员签到表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_message_log`  (
  `message_id` bigint(0) NOT NULL COMMENT '关联短信id',
  `template` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '短信模板编号',
  `phone` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '接收者',
  `subject` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '主体',
  `message` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '发送内容',
  `state` tinyint(1) NOT NULL DEFAULT 1 COMMENT '执行状态 1-执行成功 2-执行失败',
  `create_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '创建时间'
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '短信发送记录信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_notice`  (
  `notice_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '消息id',
  ...
  `buyer_user_id` bigint(0) NULL DEFAULT NULL COMMENT '客户id',
  `shop_id` bigint(0) NULL DEFAULT NULL COMMENT '店铺id',
  `notice_title` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '消息标题',
  `notice_content` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '消息内容',
  `only` bigint(0) NULL DEFAULT NULL COMMENT '跳转详情唯一标识',
  `image` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '图片',
  `create_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`notice_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 17152 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '系统消息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_order_after`  (
  `after_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '售后单id',
  `order_id` bigint(0) NOT NULL COMMENT '关联订单id',
  `after_formid` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '售后单号',
  `after_state` tinyint(0) NOT NULL DEFAULT 1 COMMENT '售后状态 1-审核中 2-退款中 3-退货中 4-退款成功 5-退款失败 6-审核不通过 7-评审中 8-退货完成，拒绝退款 9-已关闭 10-审核通过',
  ...
  `explain` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '买家说明',
  `return_reason` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '售后原因',
  `remark` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '备注',
  `reason` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '商家处理留言',
  `image` varchar(1000) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '图片地址（多个以逗号隔开）',
  `create_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`after_id`) USING BTREE,
  INDEX `idx_cere_order_after_order_id`(`order_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1052 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '售后单信息表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '订单发货信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_order_logistics`  (
  `logistics_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '物流方案id',
  `shop_id` bigint(0) NOT NULL COMMENT '店铺id',
  `logistics_name` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '方案名称',
  `charge_type` tinyint(1) NOT NULL DEFAULT 1 COMMENT '计费方式 1-按件数 2-按重量 3-全国包邮',
  `create_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`logistics_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 725 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '物流方案设置信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_order_parent`  (
  `parent_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '父订单id',
  `parent_formid` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '父订单编号',
...
) ENGINE = InnoDB AUTO_INCREMENT = 9099 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '父订单信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_order_product`  (
  `order_product_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '订单商品明细id',
  `order_id` bigint(0) NOT NULL COMMENT '关联订单id',
  `product_id` bigint(0) NOT NULL COMMENT '关联商品id',
  `sku_id` bigint(0) NOT NULL COMMENT '关联规格id',
  `product_name` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '商品名称',
  ...
  `write_number` int(0) NULL DEFAULT NULL COMMENT '已核销数量',
  `write_code` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '核销码地址',
  `activity_type` int(0) NOT NULL DEFAULT 0 COMMENT '商品活动类型 参考IntegerEnum.ACTIVITY_TYPE_XXX',
  `activity_id` bigint(0) NULL DEFAULT NULL COMMENT '活动id',
  `use_credit` int(0) NOT NULL DEFAULT 0 COMMENT '该sku抵扣的积分',
...
) ENGINE = InnoDB AUTO_INCREMENT = 10017 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '订单商品信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_order_product_attribute`  (
  `order_product_id` bigint(0) NOT NULL COMMENT '关联订单商品明细id',
  `sku_name` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '规格名',
  `sku_value` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '规格值',
  `name_code` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '规格名级别',
  `value_code` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '规格值级别'
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '订单商品属性表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_order_reconciliation`  (
  `reconciliation_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '对账单id',
  `order_id` bigint(0) NOT NULL COMMENT '关联订单id',
...
) ENGINE = InnoDB AUTO_INCREMENT = 2621 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '订单对账单信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_order_return`  (
  `return_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '退货单id',
  `return_formid` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '退货单号',
  `order_id` bigint(0) NOT NULL COMMENT '关联订单id',
  `create_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`return_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '退货单信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_pay_log`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT,
  `shop_id` bigint(0) NOT NULL COMMENT '关联店铺id',
  `order_formid` varchar(32) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '关联订单编号',
  `out_trade_no` varchar(32) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '订单支付编号',
  `transaction_id` varchar(32) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '支付生成的订单号',
  `out_refund_no` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '商户系统内部的退款单号,商户系统内部唯一，只能是数字、大小写字母_-|*@ ，同一退款单号多次请求只退一笔。退货流水号',
  `total_fee` decimal(15, 2) NULL DEFAULT NULL COMMENT '订单总金额',
  `refund_fee` decimal(15, 2) NULL DEFAULT NULL COMMENT '退款总金额，订单总金额，单位为分',
  `user_id` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '支付或退款用户ID',
  `state` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '支付、退款、提现',
  `remark` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '备注',
  `payment_mode` tinyint(1) NULL DEFAULT 1 COMMENT '支付方式 1-微信 2-支付宝',
  `after` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '售后单id,多个以逗号隔开（多次退款使用）',
  `create_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_cere_pay_log_order_formid`(`order_formid`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1474749642121803433 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '支付日志信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_platform_activity`  (
  ...
  `activity_name` varchar(60) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '优惠券活动名称',
  `activity_introduce` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '备注',
  `sign_start_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '报名开始时间',
  `sign_end_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '报名结束时间',
  `activity_start_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '活动开始时间',
  `activity_end_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '活动结束时间',
  ...
  `number` int(0) NULL DEFAULT NULL COMMENT '发放数量',
  `stock_number` int(0) NULL DEFAULT NULL COMMENT '库存数量',
  `receive_type` tinyint(1) NOT NULL COMMENT '每人限领次数  1-无限次 2-限制几次',
  `frequency` int(0) NULL DEFAULT NULL COMMENT '限制次数',
  `image` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '图片地址',
  `if_credit` tinyint(1) NOT NULL DEFAULT 0 COMMENT '是否开启积分兑换 1-是 0-否',
  `credit` int(0) NOT NULL DEFAULT 0 COMMENT '兑换所需积分',
  `apply_type` int(0) NOT NULL DEFAULT 1 COMMENT '可用范围 1-全部 2-选择类别',
  `apply_category` bigint(0) NULL DEFAULT NULL COMMENT '可用类别',
  `sync_card` tinyint(1) NOT NULL DEFAULT 0 COMMENT '是否同步微信卡券 1-同步 0-不同步',
  `card_title` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '卡券标题',
  `card_color` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '卡券主题色',
  `card_notice` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '卡券使用须知',
  `card_id` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '关联的微信卡券id',
  `state` tinyint(1) NULL DEFAULT 0 COMMENT '活动状态  0-报名未开始 1-报名进行中 2-活动待开始 3-活动进行中 4-活动已结束',
  `create_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`activity_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 180 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '平台优惠券活动信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_platform_activity_detail`  (
  ...
  `activity_id` bigint(0) NOT NULL COMMENT '关联营销活动id',
  `full_money` decimal(15, 2) NOT NULL COMMENT '满多少元',
  `reduce_money` decimal(15, 2) NOT NULL COMMENT '减多少元',
  PRIMARY KEY (`coupon_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '营销活动优惠方案明细信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_platform_after`  (
  `order_id` bigint(0) NOT NULL COMMENT '关联订单id',
  `reason` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '问题描述',
  `image` varchar(1000) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '举证图片',
  `remark` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '处理备注',
  `state` tinyint(1) NULL DEFAULT 0 COMMENT '处理状态 0-未处理 1-同意 2-拒绝',
  `create_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '创建时间',
  `handle_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '平台处理时间'
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '平台介入售后信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_platform_business`  (
  `business_user_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '商家用户id',
  `username` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '商家登录账号',
  `password` varchar(128) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '商家登录密码',
  `name` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '商家昵称',
  `sex` varchar(2) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '商家性别',
  `avatar` varchar(256) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '头像',
  `phone` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '手机号',
  `email` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '商家邮箱',
  `token` varchar(128) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '商家用户token',
  `state` tinyint(1) NULL DEFAULT NULL COMMENT '是否启用 1-是 0-否',
  `create_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`business_user_id`) USING BTREE,
  UNIQUE INDEX `uqe_idx_username`(`username`) USING BTREE,
  UNIQUE INDEX `uqe_idx_phone`(`phone`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1193 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '平台商家用户表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_platform_canvas`  (
  `canvas_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '画布id',
  `terminal` tinyint(1) NOT NULL COMMENT '终端 1-小程序 2-H5 3-APP 4-PC',
  `json` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL COMMENT '画布json数据',
  ...
  `shop_id` bigint(0) NOT NULL DEFAULT 0 COMMENT '店铺id，当type=3的时候，值为具体的店铺id，其它情况为0',
  `custom_id` bigint(0) NULL DEFAULT 0 COMMENT '自定义页面id，当type=2时，值为自定义页面对应的id，其它情况为0',
  `create_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`canvas_id`) USING BTREE,
  UNIQUE INDEX `uk_terminal_type`(`shop_id`, `terminal`, `type`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 66 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '画布信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_platform_canvas_custom`  (
  ...
  `create_time` varchar(20) CHARACTER SET utf8mb4 NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` varchar(20) CHARACTER SET utf8mb4 NULL DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COMMENT = '自定义页面信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_platform_collection`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT,
  `collection_code` varchar(255) CHARACTER SET utf8mb4 NULL DEFAULT NULL COMMENT '平台收款码地址',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COMMENT = '平台收款码信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_platform_dict`  (
  ...
  `dict_pid` bigint(0) NOT NULL COMMENT '父节点id',
  `dict_name` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '字典名称',
  `dict_describe` mediumtext CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL COMMENT '字典描述',
  `create_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`dict_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2374 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '数据字典信息表' ROW_FORMAT = Dynamic;
...
INSERT INTO `cere_platform_dict` VALUES (1872, 1870, 'wqe', 'qweq1112', '2020-11-23 23:10:51', '2021-12-26 13:48:42');
...
INSERT INTO `cere_platform_dict` VALUES (1896, 1883, '缺货', '缺货', '2020-12-09 16:18:38', '2020-12-09 16:18:38');
INSERT INTO `cere_platform_dict` VALUES (1897, 1883, '其他', '其他', '2020-12-09 16:18:38', '2020-12-09 16:18:38');
...
INSERT INTO `cere_platform_dict` VALUES (1901, 1900, 'credit_switch', '1', '2021-12-04 14:01:20', '2024-01-28 20:24:36');
INSERT INTO `cere_platform_dict` VALUES (1902, 1900, 'credit_order_rate', '20', '2021-12-04 14:02:10', '2022-09-23 01:00:59');
INSERT INTO `cere_platform_dict` VALUES (1903, 1900, 'credit_deduct_limit', '200', '2021-12-04 14:03:18', '2022-09-23 01:09:53');
INSERT INTO `cere_platform_dict` VALUES (1906, 1900, 'credit_order_amount_threshold', '1', '2021-12-28 09:22:23', '2022-09-23 01:09:42');
INSERT INTO `cere_platform_dict` VALUES (1907, 1900, 'credit_exchange_rate', '0.02', '2021-12-29 20:11:58', '2022-09-23 01:09:49');
INSERT INTO `cere_platform_dict` VALUES (1911, 0, '567', '567', '2022-04-02 09:14:41', NULL);
INSERT INTO `cere_platform_dict` VALUES (1912, 0, 'cesz', '123', '2022-05-18 11:49:41', '2023-05-22 18:18:37');
...
CREATE TABLE `cere_platform_discount`  (
  `discount_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '平台限时折扣活动id',
  `discount_name` varchar(60) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '活动名称',
  `remark` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '备注',
  `sign_start_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '报名开始时间',
  `sign_end_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '报名结束时间',
  `start_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '活动开始时间',
  `end_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '活动结束时间',
  `if_limit` tinyint(1) NOT NULL COMMENT '商品限购 1-不限购 2-限购',
  `limit_number` int(0) NULL DEFAULT NULL COMMENT '限购几件/人',
...
) ENGINE = InnoDB AUTO_INCREMENT = 477 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '平台限时折扣活动信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_platform_express`  (
  `platform_user_id` bigint(0) NULL DEFAULT NULL COMMENT '操作人用户id   初始化为空',
  `express_type` tinyint(1) NOT NULL DEFAULT 1 COMMENT '对接第三方快递类型 1-快递100 2-快递鸟',
  `update_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '更新时间'
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '物流查询策略表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_platform_label`  (
  `buyer_label_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '客户标签id',
  ...
  `consumption_day` int(0) NULL DEFAULT NULL COMMENT '最近几天（天）',
  `consumption_start_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '最后消费开始时间',
  `consumption_end_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '最后消费结束时间',
  `frequency_start` int(0) NULL DEFAULT NULL COMMENT '起始次数',
  `frequency_end` int(0) NULL DEFAULT NULL COMMENT '截止次数',
...
) ENGINE = InnoDB AUTO_INCREMENT = 20 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '平台标签信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_platform_log`  (
  ...
  `platform_user_id` bigint(0) NOT NULL COMMENT '关联用户id',
  `module` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '模块名称',
  `operation` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '操作对应工程',
  `operation_describtion` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '操作功能描述',
  `only` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '操作功能对应唯一标识id',
  `create_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '操作时间',
  PRIMARY KEY (`log_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 34112 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '平台系统日志表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_platform_member_level`  (
  `member_level_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '会员等级id',
  `member_level_name` varchar(20) CHARACTER SET utf8mb4 NOT NULL COMMENT '等级名称',
  `member_level_icon` varchar(255) CHARACTER SET utf8mb4 NOT NULL COMMENT '等级图标地址',
  `member_level_background` varchar(255) CHARACTER SET utf8mb4 NOT NULL COMMENT '等级背景图地址',
  `growth` int(0) UNSIGNED NOT NULL DEFAULT 0 COMMENT '成长值',
  `member_ids` varchar(255) CHARACTER SET utf8mb4 NOT NULL COMMENT '会员权益id(多个以逗号隔开)',
  `member_level_reason` varchar(255) CHARACTER SET utf8mb4 NULL DEFAULT NULL COMMENT '会员等级说明',
  `create_time` varchar(20) CHARACTER SET utf8mb4 NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` varchar(20) CHARACTER SET utf8mb4 NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`member_level_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 16 CHARACTER SET = utf8mb4 COMMENT = '平台会员等级信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_platform_membership`  (
  `member_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '会员权益id',
  `member_name` varchar(20) CHARACTER SET utf8mb4 NOT NULL COMMENT '权益名称',
  `member_icon` varchar(255) CHARACTER SET utf8mb4 NOT NULL COMMENT '权益图标地址',
  `member_reason` varchar(255) CHARACTER SET utf8mb4 NULL DEFAULT NULL COMMENT '权益说明',
  `create_time` varchar(20) CHARACTER SET utf8mb4 NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` varchar(20) CHARACTER SET utf8mb4 NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`member_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 15 CHARACTER SET = utf8mb4 COMMENT = '会员权益信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_platform_permission`  (
  `permission_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '权限id',
  `permission_pid` bigint(0) NOT NULL COMMENT '父节点id',
  `permission_name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '名称',
  `permission_uri` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '路由URI',
  `permission` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '组件',
  `icon` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '图标地址',
  `describe` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '文字描述',
  `resource_type` enum('menu','button','catalog') CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '权限类型',
  `sort` int(0) NULL DEFAULT NULL COMMENT '排序号',
  `project` bigint(0) NULL DEFAULT NULL,
  `create_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`permission_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 11303 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '权限菜单信息表' ROW_FORMAT = Dynamic;
...
INSERT INTO `cere_platform_permission` VALUES (4, 1, '菜单管理', '', '/setup/tabs', 'Aim', '菜单', 'menu', 4, 1, '2020-11-12 15:44:56', '2023-12-10 18:18:13');
...
INSERT INTO `cere_platform_permission` VALUES (496, 0, '终端装修', '', 'https://ceres.zkthink.com/admin-web/canvas.html', 'zk-icon-shop-decoration', '页面装修', 'catalog', 496, 1, '2021-01-13 23:37:04', '2023-12-25 17:02:01');
...
INSERT INTO `cere_platform_permission` VALUES (4095, 0, '二次认证管理', '', 'privacy', 'Connection', '', 'catalog', 2, 0, '2022-02-18 17:57:13', '2023-10-29 09:30:30');
...
INSERT INTO `cere_platform_permission` VALUES (4229, 69, '手机号管理', '', '/setup/phone', 'Phone', '', 'menu', 1555, 0, '2022-02-21 15:30:56', NULL);
...
INSERT INTO `cere_platform_permission` VALUES (8124, 0, '企业管理', '', 'enterprise', 'zk-icon-member', '企业', 'catalog', 10244, 1, '2023-05-23 18:11:08', NULL);
INSERT INTO `cere_platform_permission` VALUES (8125, 0, '企业管理', '', 'company', 'zk-icon-member', '企业管理', 'catalog', 1, 1, '2023-05-23 18:12:37', NULL);
INSERT INTO `cere_platform_permission` VALUES (8126, 8125, '企业余额', '', 'company', 'zk-icon-finance', '企业管理', 'menu', 10245, 1, '2023-05-23 18:14:05', NULL);
INSERT INTO `cere_platform_permission` VALUES (8383, 0, '二次认证管理', '', 'two', 'Position', '', 'catalog', 5, 1, '2023-08-11 15:04:31', '2023-10-28 21:47:04');
INSERT INTO `cere_platform_permission` VALUES (11075, 0, '内容管理', '', '/content', 'ChatLineSquare', '', 'menu', 10385, 1, '2024-04-30 15:54:24', NULL);
INSERT INTO `cere_platform_permission` VALUES (11076, 0, '内容管理', '', '/content', 'ChatLineSquare', '', 'catalog', 1, 1, '2024-04-30 15:56:47', '2024-04-30 16:02:49');
INSERT INTO `cere_platform_permission` VALUES (11077, 11076, '种草管理', '', '/content/manage', 'Promotion', '', 'menu', 10387, 1, '2024-04-30 15:57:21', '2024-04-30 16:11:30');
INSERT INTO `cere_platform_permission` VALUES (11078, 11076, '内容风控', '', '/content/control', 'Clock', '', 'menu', 10388, 1, '2024-04-30 16:01:06', '2024-04-30 16:12:01');
INSERT INTO `cere_platform_permission` VALUES (11079, 11076, '种草分类', '', '/content/classify', 'Odometer', '', 'menu', 10389, 1, '2024-04-30 16:12:56', NULL);
INSERT INTO `cere_platform_permission` VALUES (11080, 0, '内容管理', '', '/content', 'ChatDotRound', '', 'catalog', 1, 0, '2024-04-30 16:13:46', NULL);
INSERT INTO `cere_platform_permission` VALUES (11081, 11080, '种草动态', '', '/content/dynamic', 'Comment', '', 'menu', 10390, 0, '2024-04-30 16:14:10', NULL);
INSERT INTO `cere_platform_permission` VALUES (11082, 11080, '种草评论', '', '/content/comment', 'WarnTriangleFilled', '', 'menu', 10391, 0, '2024-04-30 16:14:28', NULL);
...
CREATE TABLE `cere_platform_polite`  (
  `polite_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '支付有礼活动id',
  `polite_name` varchar(60) CHARACTER SET utf8mb4 NOT NULL COMMENT '活动名称',
  `remark` varchar(255) CHARACTER SET utf8mb4 NULL DEFAULT NULL COMMENT '备注',
  `start_time` varchar(20) CHARACTER SET utf8mb4 NOT NULL COMMENT '活动开始时间',
  `end_time` varchar(20) CHARACTER SET utf8mb4 NOT NULL COMMENT '活动结束时间',
  `buyer_mode` tinyint(1) NOT NULL COMMENT '消费方式   1-购买一定金额商品 2-购买一定数量商品',
  `buyer` decimal(15, 2) NULL DEFAULT NULL COMMENT '满多少元/件,参与活动',
  `growth` int(0) NULL DEFAULT NULL COMMENT '会员成长值',
  `credit` int(0) NULL DEFAULT NULL COMMENT '积分',
  `state` tinyint(0) UNSIGNED NOT NULL DEFAULT 0 COMMENT '状态 0-未开始 1-进行中 2-已结束',
  `create_time` varchar(20) CHARACTER SET utf8mb4 NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` varchar(20) CHARACTER SET utf8mb4 NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`polite_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 57 CHARACTER SET = utf8mb4 COMMENT = '平台支付有礼活动信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_platform_polite_activity`  (
  `polite_id` bigint(0) NOT NULL COMMENT '平台支付有礼活动id',
  `activity_id` bigint(0) NOT NULL COMMENT '平台优惠券活动id',
  `activity_name` varchar(60) CHARACTER SET utf8mb4 NOT NULL COMMENT '优惠券名称',
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COMMENT = '平台支付有礼活动优惠券信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_platform_role`  (
  ...
  `role_describe` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '角色描述',
  `project` bigint(0) NULL DEFAULT NULL,
  `create_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`role_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3474 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '角色信息表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of cere_platform_role
-- ----------------------------
INSERT INTO `cere_platform_role` VALUES (1, '管理员', '平台端管理员', 1, '2021-12-03 19:14:39', '2021-12-03 19:14:39');
...
CREATE TABLE `cere_platform_role_permission`  (
  ...
  `permission_id` bigint(0) NOT NULL COMMENT '关联权限id'
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '平台账户角色关联权限实体类' ROW_FORMAT = Dynamic;
...
INSERT INTO `cere_platform_role_permission` VALUES (1, 11076);
INSERT INTO `cere_platform_role_permission` VALUES (1, 11077);
INSERT INTO `cere_platform_role_permission` VALUES (1, 11078);
INSERT INTO `cere_platform_role_permission` VALUES (1, 11079);
...
CREATE TABLE `cere_platform_seckill`  (
  `seckill_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '平台秒杀活动id',
  `seckill_name` varchar(60) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '活动名称',
  `remark` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '备注',
  `sign_start_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '报名开始时间',
  `sign_end_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '报名结束时间',
  `start_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '活动开始时间',
...
) ENGINE = InnoDB AUTO_INCREMENT = 159 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '平台秒杀活动信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_platform_sensitive`  (
  ...
  `sensitive_word` varchar(500) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '敏感词库',
  `state` tinyint(1) NULL DEFAULT 0 COMMENT '是否开启 1-是 0-否',
  `handle_measures` tinyint(1) NULL DEFAULT NULL COMMENT '处理措施  1-禁止发布 2-需审核',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '敏感词库信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_platform_shop`  (
  `shop_id` bigint(0) NOT NULL AUTO_INCREMENT,
  `shop_code` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '商家编码',
  `shop_name` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '店铺名称',
  `shop_brief` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '简介',
  `shop_phone` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '店铺账号',
  `shop_password` varchar(128) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '店铺密码',
  `charge_person_name` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '店铺负责人',
  `charge_person_phone` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '负责人电话',
  `shop_adress` varchar(500) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '店铺地址',
  `shop_adress_province` varchar(500) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '店铺地址-省',
  `shop_adress_city` varchar(500) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '店铺地址-市',
  `shop_adress_detail` varchar(500) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '店铺地址-详细地址',
  `shop_logo` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '店铺logo',
  `effective_date` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '生效日期  即时生效-设置当前时间 有值-指定日期生效',
  `effective_year` int(0) NULL DEFAULT NULL COMMENT '生效时限（年）',
  ...
  `wx_image` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '微信收款码',
  `ailpay_image` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '支付宝收款码',
  `create_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '更新时间',
  `divide` int(0) NULL DEFAULT NULL COMMENT '交易分成比例',
  `collection_code` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '平台收款码',
...
) ENGINE = InnoDB AUTO_INCREMENT = 393 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '商家信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_platform_user`  (
  `platform_user_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '账户id',
  `username` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '平台登录账号',
  `name` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '昵称',
  `sex` varchar(5) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '性别',
  `phone` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '账户手机号',
  `password` varchar(128) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '账户登录密码',
  `email` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '邮箱',
  `avatar` varchar(256) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '头像',
  `token` varchar(128) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '账户token',
  `state` tinyint(1) NOT NULL COMMENT '是否启用   1-是 0-否',
  `create_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`platform_user_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 58 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '平台账户信息表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of cere_platform_user
-- ----------------------------
INSERT INTO `cere_platform_user` VALUES (1, 'admin', '超级管理员', '男', '16602772291', 'CNJmcGxnwmM=', '123@qq.com', 'https://zk-cereshop.oss-cn-shenzhen.aliyuncs.com/zkthink/2023-04-10/17e41cc5ae504d328ea3429709031a35_head_puppy_3.jpeg', '25688849050275230525326913686821', 1, '2020-11-12 11:21:00', '2020-12-26 23:25:01');
INSERT INTO `cere_platform_user` VALUES (2, 'root', '大权限账号', '男', '1234567890', 'CNJmcGxnwmM=', '', 'https://zk-cereshop.oss-cn-shenzhen.aliyuncs.com/zkthink/2022-09-08/6bdb73982e554e7e94a4e2ba6319dffd_圆图文.png', '35368864234512913471179324934188357173919124784696669117597844778111851437381581271814584828771547753971216121288583925785975317', 1, '2020-12-23 19:10:56', '2023-03-28 23:32:24');
...
CREATE TABLE `cere_platform_user_role`  (
  `platform_user_id` bigint(0) NOT NULL COMMENT '平台账户编号',
  `role_id` bigint(0) NOT NULL COMMENT '关联角色表id'
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '平台账户关联角色信息表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of cere_platform_user_role
-- ----------------------------
INSERT INTO `cere_platform_user_role` VALUES (1, 1);
...
CREATE TABLE `cere_platform_web_log`  (
  `web_log_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '请求记录id',
  `name` varchar(50) CHARACTER SET utf8mb4 NULL DEFAULT NULL COMMENT '请求用户名',
  `url` varchar(50) CHARACTER SET utf8mb4 NULL DEFAULT NULL COMMENT '请求接口地址',
  `params` mediumtext CHARACTER SET utf8mb4 NULL COMMENT '请求接口参数',
  `type` tinyint(1) NULL DEFAULT NULL COMMENT '请求服务类型    1-平台端 2-商家端 3-C端',
  `ip` varchar(120) CHARACTER SET utf8mb4 NULL DEFAULT NULL COMMENT 'IP地址',
  `ip_source` varchar(50) CHARACTER SET utf8mb4 NULL DEFAULT NULL COMMENT 'IP来源',
  `describe` varchar(255) CHARACTER SET utf8mb4 NULL DEFAULT NULL COMMENT '描述',
  `browser_name` varchar(20) CHARACTER SET utf8mb4 NULL DEFAULT NULL COMMENT '浏览器',
  `time` int(0) NULL DEFAULT NULL COMMENT '耗时',
  `create_time` varchar(20) CHARACTER SET utf8mb4 NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`web_log_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 222013 CHARACTER SET = utf8mb4 COMMENT = '接口请求记录表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_platform_word`  (
  `word_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '关键词id',
  `key_word` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '关键词内容',
  `state` tinyint(1) NOT NULL DEFAULT 1 COMMENT '是否启用 1-是 0-否',
  `create_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`word_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 18 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '关键词信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_platfrom_message`  (
  `message_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '短信id',
  `message_project` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '第三方短信名称',
  `message_template` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '短信模板名称',
  `template_code` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '模板编码',
  `template_sign` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '模板签名',
  `template_describe` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '模板描述',
  `state` tinyint(1) NOT NULL DEFAULT 0 COMMENT '是否启用 1-是 0-否',
  `create_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`message_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '短信账号配置信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_popup_advert`  (
  ...
  `jump_type` int(0) NOT NULL COMMENT '跳转类型 1-商品 2-分类 3-优惠券 4-小程序 5-公众号文章',
  `jump_content` varchar(8192) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '跳转内容，根据jump_type不同存储不同的内容',
  `trigger_condition` int(0) NOT NULL DEFAULT 1 COMMENT '触发条件 1-首页 2-支付完成页',
  `apply_group` int(0) NOT NULL DEFAULT 1 COMMENT '应用人群 1-所有人 2-会员',
  `state` int(0) NOT NULL DEFAULT 1 COMMENT '状态 1-有效 0-无效',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '弹窗广告表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_price_product`  (
  `price_id` bigint(0) NOT NULL COMMENT '定价捆绑id',
  `product_id` bigint(0) NOT NULL COMMENT '商品id'
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COMMENT = '商家定价捆绑商品信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_price_rule`  (
  `price_id` bigint(0) NOT NULL COMMENT '定价捆绑id',
  `number` int(0) NOT NULL COMMENT '任选几件',
  `price` decimal(15, 2) NOT NULL COMMENT '捆绑价'
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COMMENT = '商家定价捆绑优惠规则信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_privacy_verify_setting`  (
  ...
  `project` int(0) NOT NULL COMMENT '平台端为1，商家端则为shop_id',
...
CREATE TABLE `cere_product_answer`  (
  `answer_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '回答id',
  `problem_id` bigint(0) NOT NULL COMMENT '提问id',
  `product_id` bigint(0) NOT NULL COMMENT '商品id',
  `buyer_user_id` bigint(0) NOT NULL COMMENT '客户id',
  `answer` varchar(255) CHARACTER SET utf8mb4 NULL DEFAULT NULL,
  `if_anonymous` tinyint(1) NOT NULL COMMENT '是否匿名 1-是 0-否',
  `selected` tinyint(1) NULL DEFAULT NULL COMMENT '是否选中 1-是 0-否',
  `create_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '回答时间',
  PRIMARY KEY (`answer_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 175 CHARACTER SET = utf8mb4 COMMENT = '商品提问回答信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_product_classify`  (
  `classify_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '分类id',
  `classify_pid` bigint(0) NOT NULL COMMENT '分类父id',
  `classify_hierarchy` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '分类层级结构名称',
  `classify_level` tinyint(0) NOT NULL COMMENT '分类级别',
  `classify_level_hierarchy` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '分类层级结构',
  `classify_name` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '分类名称',
  `classify_image` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '分类图片地址',
  `sort` int(0) NULL DEFAULT NULL COMMENT '排序号',
  `link` bigint(0) NULL DEFAULT NULL COMMENT '链接(取数据字典)',
  `create_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`classify_id`) USING BTREE,
  INDEX `idx_classify_pid`(`classify_pid`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 907 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '商品分类信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_product_image`  (
  `product_id` bigint(0) NOT NULL COMMENT '关联商品id',
  `product_image` varchar(1000) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '图片地址',
  `sort` int(0) NULL DEFAULT NULL COMMENT '排序值',
  INDEX `idx_cere_product_image_product_id`(`product_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '商品图片信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_product_member`  (
  `product_id` bigint(0) NOT NULL COMMENT '商品id',
  `sku_id` bigint(0) NOT NULL COMMENT '规格id',
  `member_level_id` bigint(0) NOT NULL COMMENT '会员等级id',
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COMMENT = '商品会员价格信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_product_problem`  (
  `problem_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '提问id',
  `product_id` bigint(0) NOT NULL COMMENT '商品id',
  `problem` varchar(255) CHARACTER SET utf8mb4 NULL DEFAULT NULL,
  `buyer_user_id` bigint(0) NOT NULL COMMENT '客户id',
  `if_anonymous` tinyint(1) NOT NULL COMMENT '是否匿名 1-是 0-否',
  `selected` tinyint(1) NULL DEFAULT NULL COMMENT '是否选中 1-是 0-否',
  `create_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '提问时间',
  PRIMARY KEY (`problem_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 434 CHARACTER SET = utf8mb4 COMMENT = '商品提问信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_product_sku`  (
  `sku_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '商品规格id',
  `product_id` bigint(0) NOT NULL COMMENT '关联商品id',
  `SKU` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT 'SKU',
  `price` decimal(15, 2) NOT NULL COMMENT '售价',
  `original_price` decimal(15, 2) NOT NULL COMMENT '原价',
  `stock_number` int(0) NULL DEFAULT NULL COMMENT '库存数量',
  `total` int(0) NULL DEFAULT NULL COMMENT '库存总数',
  `weight` decimal(15, 2) NULL DEFAULT NULL COMMENT '重量',
  `sku_image` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '规格图片地址',
...
) ENGINE = InnoDB AUTO_INCREMENT = 5334 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '商品规格信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_product_stats_by_day`  (
  ...
  `product_id` bigint(0) NOT NULL COMMENT '商品id',
  `shop_id` bigint(0) NOT NULL COMMENT '店铺id',
  `add_cart_count` int(0) NOT NULL DEFAULT 0 COMMENT '加购量',
  `visit_count` int(0) NOT NULL DEFAULT 0 COMMENT '访问量',
...
CREATE TABLE `cere_recommend_comment`  (
  `recommend_comment_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '种草评论id',
  `root_comment_id` bigint(0) NULL DEFAULT NULL COMMENT '最上级评论id',
  `parent_comment_id` bigint(0) NULL DEFAULT NULL COMMENT '父评论ID，若为一级评论则为NUL',
  `recommend_id` bigint(0) NOT NULL COMMENT '种草id',
  `user_id` bigint(0) NOT NULL COMMENT '评论用户id',
  `user_type` tinyint(0) NOT NULL COMMENT '评论用户类型：1、用户，2、商家',
  `target_user_id` bigint(0) NULL DEFAULT NULL COMMENT '目标评论用户id',
  `target_user_type` tinyint(0) NULL DEFAULT NULL COMMENT '目标评论用户类型：1、用户，2、商家',
  `content` text CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '评论内容',
  `read_status` tinyint(0) NULL DEFAULT 0 COMMENT '是否已读：0、未读 1、已读',
  `reply_count` int(0) NULL DEFAULT 0 COMMENT '回复数',
  `create_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`recommend_comment_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 283 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '种草评论表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_recommend_likes`  (
  `recommend_like_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '种草点赞id',
  `user_id` bigint(0) NOT NULL COMMENT '点赞用户id',
  `recommend_id` bigint(0) NOT NULL COMMENT '种草id',
  `create_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`recommend_like_id`) USING BTREE,
  INDEX `idx_recommend_id`(`recommend_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 124 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '种草点赞表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_recommend_relation`  (
  `recommend_relation_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '关联id',
  `recommend_id` bigint(0) NOT NULL COMMENT '种草id',
  `product_id` bigint(0) NOT NULL COMMENT '商品id',
  PRIMARY KEY (`recommend_relation_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 141 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '种草商品关联表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_recommend_trends`  (
  `recommend_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '种草id',
  `shop_id` bigint(0) NULL DEFAULT NULL COMMENT '店铺id',
  `recommend_type` tinyint(1) NOT NULL COMMENT '种草类型',
  `file_type` tinyint(1) NOT NULL COMMENT '文件类型 1-图文 2-视频',
  `cover` text CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL COMMENT '封面',
  `file_url` text CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL COMMENT '文件地址',
  `remark` text CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL COMMENT '文案',
  `review_content` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '审核内容',
  `publish_status` tinyint(1) NULL DEFAULT 0 COMMENT '发布状态 0-未审核 1-已发布 2-审核失败',
  `product_count` int(0) NULL DEFAULT 0 COMMENT '商品数量',
  `like_count` int(0) NULL DEFAULT 0 COMMENT '点赞数',
  `comment_count` int(0) NULL DEFAULT 0 COMMENT '评论数',
  `browse_count` int(0) NULL DEFAULT 0 COMMENT '浏览数',
  `share_count` int(0) NULL DEFAULT 0 COMMENT '分享数',
  `publish_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '发布时间',
  `create_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`recommend_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 93 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '种草动态表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_recommend_type`  (
  `recommend_type_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '关联id',
  `name` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '类型名称',
  `sort` int(0) NOT NULL COMMENT '排序',
  PRIMARY KEY (`recommend_type_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 17 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '种草类型管理表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_redis_key`  (
  `redis_key` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT 'redis的延时任务key',
  `end_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '结束时间（到这个时间就需要业务处理）'
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = 'redis的过期键信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_risk_black`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT,
  `type` int(0) NOT NULL COMMENT '类型 1：ip  2:用户',
  `ip` varchar(100) CHARACTER SET utf8mb4 NULL DEFAULT NULL COMMENT 'ip地址',
  `buyer_user_id` bigint(0) NULL DEFAULT NULL COMMENT '用户id',
  `state` tinyint(1) NULL DEFAULT 1 COMMENT '是否有效，0否 1是',
  `create_time` varchar(20) CHARACTER SET utf8mb4 NOT NULL COMMENT '创建时间',
  `update_time` varchar(20) CHARACTER SET utf8mb4 NOT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COMMENT = '黑名单表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_risk_rule`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT,
  `rule_name` varchar(100) CHARACTER SET utf8mb4 NOT NULL COMMENT '规则名称',
  `status` int(0) NOT NULL DEFAULT 0 COMMENT '状态 0未发布 1已发布',
  `rule_type` int(0) NOT NULL COMMENT '触发条件 1：满足任一一项  2：满足所有',
  `rule_place_order_limit` varchar(500) CHARACTER SET utf8mb4 NULL DEFAULT NULL COMMENT '创建订单数限制规则，json保存参数',
  `rule_wait_pay_limit` varchar(500) CHARACTER SET utf8mb4 NULL DEFAULT NULL COMMENT '待付款订单数限制规则，json保存参数',
  `rule_sku_limit` varchar(500) CHARACTER SET utf8mb4 NULL DEFAULT NULL COMMENT '单sku商品采购数限制规则，json保存参数',
  `rule_post_sale_limit` varchar(500) CHARACTER SET utf8mb4 NULL DEFAULT NULL COMMENT '单sku商品采购数限制规则，json保存参数',
  `rule_switch_post_sale` int(0) NOT NULL DEFAULT 0 COMMENT '售后规则开关  0关闭 1开启',
  `rule_switch_sku` int(0) NOT NULL DEFAULT 0 COMMENT '单sku商品规则开关 0关闭 1开启',
  `rule_switch_place_order` int(0) NOT NULL DEFAULT 0 COMMENT '下单规则开关 0关闭 1开启',
  `rule_switch_wait_pay` int(0) NOT NULL DEFAULT 0 COMMENT '待付款规则开关 0关闭 1开启',
  `create_time` varchar(20) CHARACTER SET utf8mb4 NOT NULL COMMENT '创建时间',
  `update_time` varchar(20) CHARACTER SET utf8mb4 NOT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COMMENT = '风控规则表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_shop_bank`  (
  `shop_id` bigint(0) NOT NULL COMMENT '关联店铺id',
  `card_name` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '持卡人姓名',
  `card_number` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '银行卡号',
  `bank` bigint(0) NOT NULL COMMENT '所属银行（取数据字典）'
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '店铺收款账户信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_shop_banner`  (
  `banner_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT 'banner配置id',
  `shop_id` bigint(0) NOT NULL COMMENT '关联店铺id',
  `banner_style` tinyint(1) NOT NULL COMMENT '样式   1-留边  2-填充',
  `banner_image` varchar(1000) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT 'banner图片地址（多张图片以逗号隔开）',
  `banner_url` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '跳转地址',
  `state` tinyint(1) NOT NULL COMMENT '是否启用 1-是 0-否',
  `create_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`banner_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = 'banner配置信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_shop_cart`  (
  `cart_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '购物车id',
  `buyer_user_id` bigint(0) NOT NULL COMMENT '关联客户id',
  `shop_id` bigint(0) NOT NULL COMMENT '店铺id',
  `product_id` bigint(0) NOT NULL COMMENT '关联商品id',
  `sku_id` bigint(0) NOT NULL COMMENT '关联规格id',
...
) ENGINE = InnoDB AUTO_INCREMENT = 5150 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '购物车信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_shop_channel_activity`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '渠道活动id',
  `shop_id` bigint(0) NOT NULL COMMENT '店铺id',
  ...
  `publish_count` int(0) NOT NULL DEFAULT 1 COMMENT '活动发放数量',
  `remain_count` int(0) NOT NULL DEFAULT 0 COMMENT '剩余份数',
  `state` int(0) NOT NULL COMMENT '状态 0-未开始 1-已开始 2-已结束',
  `create_time` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '创建时间',
  `update_time` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 46 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '渠道活动表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_shop_channel_activity_coupon`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '渠道活动id',
  `coupon_id` bigint(0) NOT NULL COMMENT '渠道券id',
  `shop_id` bigint(0) NOT NULL COMMENT '店铺id',
  `create_time` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '创建时间',
  `update_time` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`, `coupon_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 46 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '渠道活动关联渠道券表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_shop_check`  (
  `check_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '处理id',
  `shop_id` bigint(0) NOT NULL COMMENT '关联店铺id',
  `check_handle` tinyint(1) NOT NULL COMMENT '入住处理 1-同意入驻 0-拒绝入驻',
  `reason` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '处理原因',
  `create_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`check_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 119 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '店铺入驻处理信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_shop_comment`  (
  ...
  `shop_id` bigint(0) NOT NULL COMMENT '关联店铺id',
  `shop_name` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '商家名称',
  `shop_code` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '商家编码',
  `product_id` bigint(0) NULL DEFAULT NULL COMMENT '关联商品id',
  `sku_id` bigint(0) NULL DEFAULT NULL COMMENT '规格id',
  `order_id` bigint(0) NULL DEFAULT NULL COMMENT '订单id',
  `buyer_user_id` bigint(0) NULL DEFAULT NULL COMMENT '关联客户id',
  `image` varchar(1000) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '图片地址（多个以逗号隔开）',
  `add_image` varchar(1000) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '追加图片',
  `comment` varchar(255) CHARACTER SET utf8mb4 NULL DEFAULT NULL,
  `add_comment` varchar(255) CHARACTER SET utf8mb4 NULL DEFAULT NULL,
  `state` tinyint(1) NULL DEFAULT 0 COMMENT '是否隐藏 1-是 0-否',
  `if_sensitive` tinyint(1) NULL DEFAULT 0 COMMENT '是否敏感词审核  1-是 0-否',
  `add_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '追评时间',
  ...
  `impression` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '商品印象',
  `create_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`comment_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 327 CHARACTER SET = utf8mb4 COMMENT = '客户评论信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_shop_compose`  (
  `compose_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '组合捆绑id',
  `shop_id` bigint(0) NOT NULL COMMENT '店铺id',
  `compose_name` varchar(60) CHARACTER SET utf8mb4 NOT NULL COMMENT '组合名称',
  `start_time` varchar(20) CHARACTER SET utf8mb4 NOT NULL COMMENT '活动开始时间',
  `end_time` varchar(20) CHARACTER SET utf8mb4 NOT NULL COMMENT '活动结束时间',
...
) ENGINE = InnoDB AUTO_INCREMENT = 80 CHARACTER SET = utf8mb4 COMMENT = '商家组合捆绑信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_shop_conversion`  (
  ...
  `create_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '转化时间'
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '店铺转化信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_shop_coupon`  (
  `shop_coupon_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '店铺优惠券id',
  `shop_id` bigint(0) NOT NULL COMMENT '店铺id',
  `coupon_name` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '优惠券名称',
  `remark` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '备注',
  `coupon_type` tinyint(1) NOT NULL COMMENT '优惠券类型 1-满减券 2-折扣券',
  ...
  `take_start` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '领券开始时间',
  `take_end` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '领券结束时间',
  `effective_start` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '用券开始时间',
  `effective_end` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '用券结束时间',
  `effective_day` int(0) NULL DEFAULT NULL COMMENT '领券当日几天内（天数）',
  `number` int(0) NULL DEFAULT NULL COMMENT '发放数量',
  `stock_number` int(0) NULL DEFAULT NULL COMMENT '库存数量',
  `receive_type` tinyint(1) NOT NULL COMMENT '每人限领次数  1-无限次 2-限制几次',
  `frequency` int(0) NULL DEFAULT NULL COMMENT '限制次数',
  ...
  `type` int(0) NOT NULL DEFAULT 1 COMMENT '优惠券分类 1-普通券 2-渠道券',
  `create_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`shop_coupon_id`) USING BTREE,
  INDEX `idx_shop_id`(`shop_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 480 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '店铺优惠券信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_shop_coupon_detail`  (
  `shop_coupon_id` bigint(0) NOT NULL COMMENT '店铺优惠券id',
  `product_id` bigint(0) NOT NULL COMMENT '商品id'
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '店铺优惠券商品明细信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_shop_crowd`  (
  `shop_crowd_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '店铺人群id',
  `shop_id` bigint(0) NOT NULL COMMENT '店铺id',
  `crowd_name` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '人群名称',
  `shop_buy_yes` int(0) NULL DEFAULT NULL COMMENT '店铺有购买最近几天购买过本店商品的客户（以支付成功为准，不剔除退款）',
  `shop_buy_no` int(0) NULL DEFAULT NULL COMMENT '店铺无购买最近几天没有购买过本店商品的客户（以支付成功为准，不剔除退款）',
  `shop_order_yes` int(0) NULL DEFAULT NULL COMMENT '店铺有下单最近几天在店铺有下单行为的客户（包含未付款客户）',
  `shop_order_no` int(0) NULL DEFAULT NULL COMMENT '店铺无下单最近几天（在店铺没有下单行为的客户）',
  `shop_add_yes` int(0) NULL DEFAULT NULL COMMENT '店铺有加购最近几天（加购过本店商品的客户）',
  `shop_add_no` int(0) NULL DEFAULT NULL COMMENT '店铺无加购最近几天（没有加购过本店商品的客户）',
  `shop_visit_yes` int(0) NULL DEFAULT NULL COMMENT '店铺有访问最近几天（访问过本店的客户）',
  `shop_visit_no` int(0) NULL DEFAULT NULL COMMENT '店铺无访问最近几天（没有访问过本店的客户）',
  `effective_buy` tinyint(1) NULL DEFAULT NULL COMMENT '有效购买次数比较类型  1-大于 2-等于 3-小于',
  `effective_buy_count` int(0) NULL DEFAULT NULL COMMENT '有效购买次数，客户累计在店铺交易成功的订单数量（剔除退款的订单）',
  ...
  `users` int(0) NULL DEFAULT NULL COMMENT '客户数量',
  `label_id` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '商家标签id，多个以逗号隔开',
  `ids` mediumtext CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL COMMENT '客户id，多个以逗号隔开',
  `create_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`shop_crowd_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 47 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '客户分群信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_shop_customer_service`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_shop_id`(`shop_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 32 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '店铺客服关联表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_shop_discount`  (
  `shop_discount_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '店铺限时折扣活动id',
  `shop_id` bigint(0) NOT NULL COMMENT '店铺id',
  `discount_name` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '活动名称',
  `remark` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '备注',
  `start_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '活动开始时间',
  `end_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '活动结束时间',
  `if_limit` tinyint(1) NOT NULL COMMENT '商品限购 1-不限购 2-限购',
  ...
  `number` int(0) NULL DEFAULT NULL COMMENT '限制数量',
  `if_enable` tinyint(1) NOT NULL COMMENT '活动预热   1-停用  2-启用',
  `enable_time` int(0) NULL DEFAULT NULL COMMENT '预热几小时前',
  `if_add` tinyint(1) NOT NULL COMMENT '优惠券是否叠加 1-是 0-否',
  `state` tinyint(1) NULL DEFAULT NULL COMMENT '限时折扣活动状态 0-未开始 1-进行中 2-已结束',
  `create_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`shop_discount_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 105 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '店铺限时折扣活动信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_shop_discount_detail`  (
  `shop_discount_id` bigint(0) NOT NULL COMMENT '店铺限时折扣活动id',
  `product_id` bigint(0) NOT NULL COMMENT '商品id',
  `sku_id` bigint(0) NOT NULL COMMENT '规格id',
  `discount` decimal(15, 2) NOT NULL COMMENT '折扣',
  `price` decimal(15, 2) NOT NULL COMMENT '活动价格',
  `number` int(0) NULL DEFAULT NULL COMMENT '限量数量（剩余）',
  `total` int(0) NULL DEFAULT NULL COMMENT '限制总数'
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '店铺限时折扣活动商品明细信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_shop_distribution_level`  (
  `distributor_level_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '分销员等级id',
  `shop_id` bigint(0) NOT NULL COMMENT '关联店铺id',
  `level_name` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '等级名称',
  `level_num` int(0) NOT NULL DEFAULT 1 COMMENT '等级编号，编号越大等级越高',
  `level_logo` varchar(1024) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '等级图标',
  ...
  `condition_invitation` int(0) NULL DEFAULT NULL COMMENT '邀请下级满人数',
  `condition_customer` int(0) NULL DEFAULT NULL COMMENT '客户满人数',
  `direct_proportion` int(0) NULL DEFAULT NULL COMMENT '直接分佣比例（存整数最大99）',
  `indirect_proportion` int(0) NULL DEFAULT NULL COMMENT '间接分佣比例（存整数最大99）',
  `create_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`distributor_level_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 65 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '店铺分销员等级信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_shop_distributor`  (
  `distributor_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '分销员id',
  `shop_id` bigint(0) NOT NULL COMMENT '关联店铺id',
  `distributor_name` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '分销员昵称',
  `distributor_phone` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '分销员手机号',
  `distributor_level_id` bigint(0) NULL DEFAULT NULL COMMENT '关联分销员等级id',
  `invitees` bigint(0) NULL DEFAULT NULL COMMENT '邀请人id',
  ...
  `join_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '审核通过时间',
  `invitation_code` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '邀请码',
  `create_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`distributor_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 245 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '分销员信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_shop_enterprise`  (
  `shop_id` bigint(0) NOT NULL COMMENT '关联店铺id',
  `enterprise_name` varchar(110) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '企业名称',
  `enterprise_code` varchar(18) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '统一社会信用代码',
  `enterprise_region` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '地址  省-市-区',
  `enterprise_adress` varchar(256) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '详细地址',
  `enterprise_start_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '营业期限开始时间',
  `enterprise_end_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '营业期限结束时间',
  `enterprise_license` varchar(1000) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '营业执照图片地址（多个以逗号隔开）',
  `enterprise_operator` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '法人姓名',
  `enterprise_card_type` bigint(0) NOT NULL COMMENT '证件类型 （取数据字典）',
  `enterprise_id_card` varchar(18) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '法人身份证号码',
  `enterprise_card_start_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '证件有效开始时间',
  `enterprise_card_end_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '证件有效结束时间',
  `enterprise_card_positive` varchar(1000) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '身份证正面照',
  `enterprise_card_side` varchar(1000) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '身份证反面照',
  `administrators_phone` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '' COMMENT '管理员手机号',
  `administrators_email` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '' COMMENT '管理员邮箱',
  `account_open_bank` bigint(0) NULL DEFAULT 0 COMMENT '开户银行（取数据字典）',
  `account_bank_name` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '' COMMENT '开户银行名称',
  `account_bank_region` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '' COMMENT '开户银行地区   省-市',
  `account_bank_card` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '' COMMENT '银行账户',
  `shop_abbreviation` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '' COMMENT '商户简称',
  `service_phone` varchar(16) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '' COMMENT '客服电话',
  `service_providing` bigint(0) NULL DEFAULT 0 COMMENT '提供服务（取数据字典）',
  `shop_index_image` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '' COMMENT '店铺首页截图',
  `shop_backstage_image` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '' COMMENT '店铺管理后台截图',
  `remark` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '备注',
  `create_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '更新时间'
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '店铺企业认证信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_shop_extension`  (
  `extension_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '推广设置id',
  `title` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '推广标题',
  `shop_id` bigint(0) NOT NULL COMMENT '关联店铺id',
  ...
  `extension_reason` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '推广语',
  `image` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '背景图片地址 875x1275像素',
  `poster` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '海报图片地址',
  `create_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`extension_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '店铺推广设置信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_shop_group`  (
  `shop_group_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '商品分组id',
  `shop_id` bigint(0) NOT NULL COMMENT '关联店铺id',
  `group_name` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '分组名称',
  `group_describe` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '分组描述',
  `group_image` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '分组封面图片地址',
  `create_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`shop_group_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2749 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '店铺商品分组信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_shop_group_detail`  (
  `shop_group_id` bigint(0) NOT NULL COMMENT '店铺分组id',
  `product_id` bigint(0) NOT NULL COMMENT '商品id'
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '分组关联商品信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_shop_group_work`  (
  `shop_group_work_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '店铺拼团活动id',
  `shop_id` bigint(0) NOT NULL COMMENT '店铺id',
  `group_name` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '活动名称',
  `remark` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '备注',
  `start_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '活动开始时间',
  `end_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '活动结束时间',
  `person` int(0) NOT NULL COMMENT '成团人数',
  `effective_time` int(0) NOT NULL COMMENT '成团有效时间几（小时）',
  `if_limit` tinyint(1) NOT NULL COMMENT '商品限购 1-不限购 2-限购',
  `limit_number` int(0) NULL DEFAULT NULL COMMENT '限购几件/人',
  `if_enable` tinyint(1) NOT NULL COMMENT '活动预热   1-停用  2-启用',
  `enable_time` int(0) NULL DEFAULT NULL COMMENT '预热几小时前',
...
) ENGINE = InnoDB AUTO_INCREMENT = 1005 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '店铺拼团活动信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_shop_group_work_detail`  (
  `shop_group_work_id` bigint(0) NOT NULL COMMENT '店铺拼团活动id',
  `product_id` bigint(0) NOT NULL COMMENT '商品id',
  `sku_id` bigint(0) NOT NULL COMMENT '规格id',
  `price` decimal(15, 2) NOT NULL COMMENT '拼团价格'
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '店铺拼团活动商品明细信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_shop_individual_businesses`  (
  `shop_id` bigint(0) NOT NULL COMMENT '关联店铺id',
  `subject_name` varchar(110) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '商户名称',
  `subject_code` varchar(18) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '统一社会信用代码',
  `subject_region` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '地址  省-市-区',
  `subject_adress` varchar(256) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '详细地址',
  `subject_start_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '营业期限开始时间',
  `subject_end_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '营业期限结束时间',
  `subject_license` varchar(1000) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '营业执照图片地址（多个以逗号隔开）',
  `subject_operator` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '经营者姓名',
  `subject_card_type` bigint(0) NOT NULL COMMENT '证件类型 （取数据字典）',
  `subject_id_card` varchar(18) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '经营者身份证号码',
  `subject_card_start_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '证件有效开始时间',
  `subject_card_end_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '证件有效结束时间',
  `subject_card_positive` varchar(1000) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '身份证正面照',
  `subject_card_side` varchar(1000) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '身份证反面照',
  `administrators_phone` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '' COMMENT '管理员手机号',
  `administrators_email` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '' COMMENT '管理员邮箱',
  ...
  `create_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '更新时间'
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '店铺个体工商户认证信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_shop_label`  (
  ...
  `shop_id` bigint(0) NOT NULL COMMENT '关联店铺id',
  `label_name` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '标签名称',
  `label_type` tinyint(0) NULL DEFAULT 1 COMMENT '标签类型 1-图片 2-视频',
  `create_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`label_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 196 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '店铺标签信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_shop_operate`  (
  `shop_operate_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '店铺运营计划id',
  `shop_id` bigint(0) NOT NULL COMMENT '店铺id',
  `operate_name` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '计划名称',
  `shop_crowd_id` bigint(0) NOT NULL COMMENT '店铺人群id',
  ...
  `plan_start` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '长期计划开始时间',
  `plan_end` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '长期计划结束时间',
  `manual_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '手动定时执行时间，如果为空说明是立即执行',
  `create_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`shop_operate_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 66 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '店铺运营计划信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_shop_operate_detail`  (
  `shop_operate_id` bigint(0) NOT NULL,
  `shop_coupon_id` bigint(0) NOT NULL COMMENT '店铺优惠券id',
  `number` int(0) NOT NULL COMMENT '赠券数量'
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '店铺运营计划优惠券明细信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_shop_order`  (
  ...
  `parent_id` bigint(0) NOT NULL COMMENT '关联父订单id',
  `shop_id` bigint(0) NOT NULL COMMENT '关联店铺id',
  `order_formid` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '订单ID',
  `buyer_user_id` bigint(0) NOT NULL COMMENT '关联客户id',
  `coupon_id` bigint(0) NULL DEFAULT NULL COMMENT '平台优惠券id',
  `id` bigint(0) NULL DEFAULT NULL COMMENT '客户关联商家优惠券数据主键id',
  `shop_seckill_id` bigint(0) NULL DEFAULT NULL COMMENT '店铺秒杀活动id',
  `shop_group_work_id` bigint(0) NULL DEFAULT NULL COMMENT '店铺拼团活动id',
  `shop_discount_id` bigint(0) NULL DEFAULT NULL COMMENT '店铺限时折扣活动id',
  `shop_operate_id` bigint(0) NULL DEFAULT NULL COMMENT '运营计划id',
  ...
  `payment_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '支付时间',
  `customer_name` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '下单人姓名',
  `customer_phone` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '下单人手机号',
  `receive_name` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '收货人姓名',
  `receive_phone` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '收货人手机号',
  `receive_adress` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '收货地址',
  `address` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '详细地址',
  `receive_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '成交时间',
  `postal_code` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '邮政编码',
  ...
  `logistics_id` bigint(0) NULL DEFAULT NULL COMMENT '物流方案id',
  `distributor_id` bigint(0) NULL DEFAULT NULL COMMENT '关联分销员id',
  ...
  `create_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '更新时间',
  `seckill_id` bigint(0) NULL DEFAULT NULL COMMENT '平台秒杀活动id',
  `discount_id` bigint(0) NULL DEFAULT NULL COMMENT '平台限时折扣活动id',
  `polite_id` bigint(0) NULL DEFAULT NULL COMMENT '平台支付有礼活动id',
  `scene_id` bigint(0) NULL DEFAULT NULL COMMENT '商家场景营销活动id',
...
) ENGINE = InnoDB AUTO_INCREMENT = 49742 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '订单信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_shop_other_organizations`  (
  `shop_id` bigint(0) NOT NULL COMMENT '关联店铺id',
  `other_name` varchar(110) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '组织名称',
  `other_code` varchar(18) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '组织机构代码',
  `other_region` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '地址  省-市-区',
  `other_adress` varchar(256) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '详细地址',
  `other_start_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '营业期限开始时间',
  `other_end_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '营业期限结束时间',
  `other_license` varchar(1000) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '机构证件或其他证明材料图片地址（多个以逗号隔开）',
  `other_operator` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '负责人姓名',
  `other_card_type` bigint(0) NOT NULL COMMENT '证件类型 （取数据字典）',
  `other_id_card` varchar(18) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '负责人身份证号码',
  `other_card_start_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '证件有效开始时间',
  `other_card_end_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '证件有效结束时间',
  `other_card_positive` varchar(1000) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '身份证正面照',
  `other_card_side` varchar(1000) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '身份证反面照',
  `administrators_phone` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '' COMMENT '管理员手机号',
  `administrators_email` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '' COMMENT '管理员邮箱',
  `account_open_bank` bigint(0) NULL DEFAULT 0 COMMENT '开户银行（取数据字典）',
  `account_bank_region` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '' COMMENT '开户银行地区   省-市',
  ...
  `create_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '更新时间'
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '店铺其他组织认证信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_shop_personal`  (
  `shop_id` bigint(0) NOT NULL COMMENT '关联店铺id',
  `personal_name` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '个人姓名',
  `personal_card_type` bigint(0) NOT NULL COMMENT '证件类型 （取数据字典）',
  `personal_id_card` varchar(18) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '法人身份证号码',
  `personal_card_start_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '证件有效开始时间',
  `personal_card_end_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '证件有效结束时间',
  `personal_card_positive` varchar(1000) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '身份证正面照',
  `personal_card_side` varchar(1000) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '身份证反面照',
  `personal_card_hand` varchar(1000) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '手持身份证照',
  `administrators_phone` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '' COMMENT '管理员手机号',
  `administrators_email` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '' COMMENT '管理员邮箱',
  `account_open_bank` bigint(0) NULL DEFAULT 0 COMMENT '开户银行（取数据字典）',
  `account_bank_region` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '' COMMENT '开户银行地区   省-市',
  `account_bank_card` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '' COMMENT '银行账户',
  `shop_abbreviation` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '' COMMENT '商户简称',
  `service_phone` varchar(16) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '' COMMENT '客服电话',
  `service_providing` bigint(0) NULL DEFAULT 0 COMMENT '提供服务（取数据字典）',
  `shop_index_image` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '' COMMENT '店铺首页截图',
  `shop_backstage_image` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '' COMMENT '店铺管理后台截图',
  `remark` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '备注',
  `create_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '更新时间'
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '店铺个人认证信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_shop_price`  (
  `price_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '定价捆绑id',
  `shop_id` bigint(0) NOT NULL COMMENT '店铺id',
  `compose_name` varchar(60) CHARACTER SET utf8mb4 NOT NULL COMMENT '活动名称',
  `start_time` varchar(20) CHARACTER SET utf8mb4 NOT NULL COMMENT '活动开始时间',
  `end_time` varchar(20) CHARACTER SET utf8mb4 NOT NULL COMMENT '活动结束时间',
  `state` tinyint(1) NOT NULL COMMENT '状态 0-未开始 1-进行中 2-已结束 3-已停用',
  `create_time` varchar(20) CHARACTER SET utf8mb4 NULL DEFAULT NULL COMMENT '创建时间',
...
) ENGINE = InnoDB AUTO_INCREMENT = 57 CHARACTER SET = utf8mb4 COMMENT = '商家定价捆绑信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_shop_product`  (
  ...
  `shop_id` bigint(0) NOT NULL COMMENT '关联店铺id',
  `product_name` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '商品名称',
  `product_brief` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '卖点简介',
  `product_text` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL COMMENT '商品描述（富文本）',
  `shop_group_id` bigint(0) NULL DEFAULT NULL COMMENT '关联商品分组id',
  `classify_id` bigint(0) NOT NULL COMMENT '关联分类id',
  `supplier_id` bigint(0) NULL DEFAULT NULL COMMENT '关联供应商id',
  `supplier_name` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '供应商名称',
  ...
  `create_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '更新时间',
  `fictitious_number` int(0) NOT NULL DEFAULT 0 COMMENT '虚拟销量',
  `reject` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '驳回原因',
  ...
  `credit_limit` int(0) NULL DEFAULT NULL COMMENT '单笔最大抵扣多少积分',
  `brand_id` bigint(0) NULL DEFAULT NULL COMMENT '品牌id',
  `classify_id1` bigint(0) NOT NULL DEFAULT 0 COMMENT '一级分类id',
  `classify_id2` bigint(0) NOT NULL DEFAULT 0 COMMENT '二级分类id',
  `classify_id3` bigint(0) NOT NULL DEFAULT 0 COMMENT '三级分类id',
  PRIMARY KEY (`product_id`) USING BTREE,
  INDEX `idx_classify_id1`(`classify_id1`) USING BTREE,
  INDEX `idx_classify_id2`(`classify_id2`) USING BTREE,
  INDEX `idx_classify_id3`(`classify_id3`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1998 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '店铺商品信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_shop_recruit`  (
  ...
  `frequency` int(0) NULL DEFAULT NULL COMMENT '下单次数',
  `money` decimal(15, 2) NULL DEFAULT NULL COMMENT '消费金额',
  `if_examine` tinyint(1) NOT NULL DEFAULT 1 COMMENT '是否需要审核 1-是 0-否',
  `url` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '招募页链接',
  PRIMARY KEY (`shop_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '店铺招募信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_shop_relationship`  (
  ...
  `validity_day` int(0) NULL DEFAULT NULL COMMENT '关系绑定有效天数',
  `if_robbing` tinyint(1) NOT NULL DEFAULT 2 COMMENT '抢客条件 1-随时可抢客 2-不允许抢客 3-保护期几天内不允许抢',
  `robbing_day` int(0) NULL DEFAULT NULL COMMENT '保护期天数',
  `if_distribution_relationship` tinyint(1) NOT NULL DEFAULT 1 COMMENT '是否允许分销员之间建立客户关系 1-是 0-否'
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '店铺关系设置表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_shop_return`  (
  `shop_id` bigint(0) NOT NULL COMMENT '关联店铺id',
  `return_adress` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '退货地址',
  `return_person` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '联系人',
  `return_phone` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '联系电话'
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '店铺退货地址信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_shop_scene`  (
  `scene_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '场景营销id',
  `shop_id` bigint(0) NOT NULL COMMENT '店铺id',
  `scene_type` tinyint(1) NOT NULL COMMENT '营销类型 1-节日营销 2-会员日营销 3-生日营销',
  `scene_name` varchar(60) CHARACTER SET utf8mb4 NOT NULL COMMENT '营销名称',
  `start_time` varchar(20) CHARACTER SET utf8mb4 NULL DEFAULT NULL COMMENT '开始时间',
  `end_time` varchar(20) CHARACTER SET utf8mb4 NULL DEFAULT NULL COMMENT '结束时间',
  ...
  `scene_time` varchar(255) CHARACTER SET utf8mb4 NULL DEFAULT NULL COMMENT '营销事件 每月示例1-2表示每月一日到二日；每周示例1(周一)-2（周二）-3-4-5-6-7表示全选，0代表未选；每日示例2021-01-01 10:00:00至2021-01-01 12:00:00',
  `state` tinyint(1) UNSIGNED ZEROFILL NULL DEFAULT 0 COMMENT '状态 0-未开始 1-进行中 2-已停止',
  `create_time` varchar(20) CHARACTER SET utf8mb4 NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` varchar(20) CHARACTER SET utf8mb4 NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`scene_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 122 CHARACTER SET = utf8mb4 COMMENT = '场景营销信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_shop_scene_member`  (
  `scene_id` bigint(0) NOT NULL COMMENT '场景营销id',
  `member_level_id` bigint(0) NOT NULL COMMENT '会员等级id',
  `if_free_shipping` tinyint(0) UNSIGNED NULL DEFAULT 0 COMMENT '是否包邮 1-是 0-否',
  `discount` decimal(10, 2) NULL DEFAULT NULL COMMENT '折扣'
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COMMENT = '商家场景营销规则信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_shop_scene_member_coupon`  (
  `scene_id` bigint(0) NOT NULL COMMENT '场景营销id',
  `member_level_id` bigint(0) NOT NULL COMMENT '会员等级id',
  `coupon_id` bigint(0) NOT NULL COMMENT '商家优惠券id'
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COMMENT = '商家场景营销规则会员等级优惠券信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_shop_seckill`  (
  `shop_seckill_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '店铺秒杀活动id',
  `shop_id` bigint(0) NOT NULL COMMENT '店铺id',
  `seckill_name` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '活动名称',
  `remark` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '备注',
  `effective_start` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '开始时间',
  `effective_end` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '结束时间',
  `if_limit` tinyint(1) NOT NULL COMMENT '商品限购 1-不限购 2-限购',
  `limit_number` int(0) NULL DEFAULT NULL COMMENT '限购几件/人',
  `if_number` tinyint(1) NOT NULL COMMENT '是否限量 1-是 0-否',
  `number` int(0) NULL DEFAULT NULL COMMENT '限制数量',
...
) ENGINE = InnoDB AUTO_INCREMENT = 1089 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '店铺秒杀活动信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_shop_seckill_detail`  (
  `shop_seckill_id` bigint(0) NOT NULL COMMENT '店铺秒杀活动id',
  `product_id` bigint(0) NOT NULL COMMENT '商品id',
  `sku_id` bigint(0) NOT NULL COMMENT '规格id',
  ...
  `number` int(0) NULL DEFAULT NULL COMMENT '限量数量(剩余)',
  `total` int(0) NULL DEFAULT NULL COMMENT '限制总数'
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '店铺秒杀活动商品明细信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_shop_user_label`  (
  `label_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '店铺标签id',
  `shop_id` bigint(0) NOT NULL COMMENT '关联店铺id',
  `label_name` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '标签名称',
  `remark` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '备注信息',
  `create_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`label_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1252 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '店铺用户标签信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_shop_visit`  (
  `shop_id` bigint(0) NOT NULL COMMENT '关联店铺id',
  `buyer_user_id` bigint(0) NOT NULL COMMENT '关联客户id',
  `visit_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '访问时间',
  ...
  `city` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '所在地区'
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '店铺访问信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_shop_withdrawal`  (
  `withdrawal_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '提现申请id',
  `shop_id` bigint(0) NOT NULL COMMENT '关联店铺id',
  `shop_name` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '店铺名称',
  `shop_code` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '店铺编码',
  `bank_name` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '银行名称',
  `bank_card` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '银行卡号',
  `collection_name` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '收款人姓名',
  `withdrawal_money` decimal(15, 2) NOT NULL COMMENT '提现金额',
  ...
  PRIMARY KEY (`withdrawal_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 80 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '商家提现申请信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_sign_product`  (
  `sign_id` bigint(0) NOT NULL COMMENT '关联报名id',
  `product_id` bigint(0) NOT NULL COMMENT '关联商品id',
  `number` int(0) NULL DEFAULT NULL COMMENT '商品限量（剩余）',
  `total` int(0) NULL DEFAULT NULL COMMENT '限量总数',
  INDEX `idx_sign_id`(`sign_id`) USING BTREE,
  INDEX `idx_productt_id`(`product_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '报名商品明细信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cere_sku_member_real_info`  (
  ...
  `product_id` bigint(0) NOT NULL COMMENT '商品id',
  `member_level_id` bigint(0) NOT NULL COMMENT '会员等级id, 0为未登录或无等级',
  `activity_type` int(0) NOT NULL COMMENT '参考IntegerEnum.ACTIVITY_TYPE_XXX',
  ...
  `limit_number` int(0) NOT NULL DEFAULT 0 COMMENT '限购数量',
  `if_enable` tinyint(0) NOT NULL DEFAULT 1 COMMENT '活动预热   1-停用  2-启用',
  `enable_time` int(0) NOT NULL DEFAULT 0 COMMENT '预热几小时前',
  `if_add` tinyint(1) NOT NULL DEFAULT 0 COMMENT '是否可叠加优惠券 0-不可叠加 1-可叠加',
  `person` tinyint(0) NOT NULL DEFAULT 0 COMMENT '成团人数',
  `sales_user_count` int(0) NOT NULL DEFAULT 0 COMMENT '商品维度的下单人数 只要下过单的都算',
  `sales_volume` int(0) NOT NULL DEFAULT 0 COMMENT '当前销量,根据activityType不同而有变化',
  `sku_sales_volume` int(0) NOT NULL DEFAULT 0 COMMENT '该sku总销量',
  `product_sales_volume` int(0) NOT NULL DEFAULT 0 COMMENT '商品总销量',
  ...
  `state` int(0) NOT NULL DEFAULT 0 COMMENT '活动状态 对于平台端 0-报名未开始 1-报名进行中 2-活动待开始 3-活动进行中 4-活动已结束; 对于商家端  0-未开始 1-进行中 2-已结束',
...
CREATE TABLE `cere_sku_name`  (
  ...
  `sku_name` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '规格名',
  `sku_value` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '规格值',
  `image` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '图片地址',
  `name_code` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '规格名级别',
  `value_code` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '规格值级别',
  INDEX `idx_cere_sku_name_sku_id`(`sku_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '商品规格属性信息表' ROW_FORMAT = Dynamic;
