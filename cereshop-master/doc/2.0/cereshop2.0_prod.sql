...
CREATE TABLE `cere_brand` (
  ...
  `brand_name` varchar(64) COLLATE utf8mb4_bin NOT NULL COMMENT '品牌名称',
  `brand_logo` varchar(1024) COLLATE utf8mb4_bin NOT NULL COMMENT '品牌图标',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT='品牌表';
...
CREATE TABLE `cere_buyer_comment_like` (
  ...
  PRIMARY KEY (`comment_id`,`buyer_user_id`)
...
CREATE TABLE `cere_buyer_track_report` (
  ...
  `product_ids` varchar(4096) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '商品id列表, 用,分割',
  `create_time` varchar(20) COLLATE utf8mb4_bin NOT NULL COMMENT '创建时间',
  `create_user` bigint(20) NOT NULL COMMENT '创建人id',
  PRIMARY KEY (`id`),
  KEY `idx_create_user` (`create_user`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='用户埋点上报';
...
CREATE TABLE `cere_buyer_user` (
  ...
  `terminal` int(11) NOT NULL COMMENT '注册来源 0-未知 1-APP 2-微信小程序 3-H5 4-支付宝小程序 5-PC',
  `register_ip` varchar(128) DEFAULT NULL COMMENT '注册时的ip',
  `last_login_ip` varchar(128) DEFAULT NULL COMMENT '最近一次登录时的ip',
...
CREATE TABLE `cere_channel` (
  ...
  `channel_name` varchar(32) COLLATE utf8mb4_bin NOT NULL COMMENT '渠道名称',
  `register_url` varchar(1024) COLLATE utf8mb4_bin NOT NULL COMMENT '渠道注册链接',
  `channel_code` varchar(64) COLLATE utf8mb4_bin NOT NULL COMMENT '渠道码',
  `create_time` varchar(20) COLLATE utf8mb4_bin NOT NULL COMMENT '创建时间',
  `update_time` varchar(20) COLLATE utf8mb4_bin NOT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT='渠道表';
...
CREATE TABLE `cere_logistics_charge` (
  ...
  `region` text NOT NULL COMMENT '配送区域 省-市',
...
CREATE TABLE `cere_platform_business` (
  ...
  UNIQUE KEY `uqe_idx_phone` (`phone`) USING BTREE
...
CREATE TABLE `cere_platform_dict` (
  ...
  `update_time` varchar(20) DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`dict_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2374 DEFAULT CHARSET=utf8 COMMENT='数据字典信息表';
...
) ENGINE=InnoDB AUTO_INCREMENT=4098 DEFAULT CHARSET=utf8 COMMENT='权限菜单信息表';
...
INSERT INTO `cere_platform_permission` VALUES (20, 0, '231', '', '213', 'el-icon-suitcase-1', '321', 'menu', 20, 1, '2020-11-24 09:35:17', NULL);
...
INSERT INTO `cere_platform_permission` VALUES (33, 0, '平台活动', '', '/active', 'el-icon-monitor', '', 'catalog', 32, 1, '2020-12-07 14:27:29', NULL);
...
INSERT INTO `cere_platform_permission` VALUES (39, 38, '商家列表', '', '/business/businessList', 'el-icon-set-up', '', 'menu', 39, 1, '2020-12-07 14:33:56', '2021-12-10 10:46:07');
INSERT INTO `cere_platform_permission` VALUES (40, 38, '入驻申请', '', '/business/settlement', 'el-icon-mobile', '1', 'menu', 40, 1, '2020-12-07 14:49:00', '2021-12-10 10:44:34');
INSERT INTO `cere_platform_permission` VALUES (47, 22, '导出标签', '', 'excel', 'el-icon-minus', '', 'button', 47, 1, '2020-12-07 15:06:28', NULL);
INSERT INTO `cere_platform_permission` VALUES (48, 24, '关键词管理', '', '/comment/keyword', 'el-icon-help', '', 'menu', 48, 1, '2020-12-08 20:18:02', '2021-12-15 20:20:50');
...
INSERT INTO `cere_platform_permission` VALUES (65, 64, '财务明细', '', '/finance/list', 'el-icon-notebook-2', '', 'menu', 65, 0, '2020-12-16 20:30:33', '2021-12-23 17:28:27');
INSERT INTO `cere_platform_permission` VALUES (66, 64, '收款账户', '', '/finance/account', 'el-icon-files', '', 'menu', 66, 0, '2020-12-16 20:30:53', '2021-12-23 17:29:10');
INSERT INTO `cere_platform_permission` VALUES (67, 0, '分销员', '', '/Distributor/DistributorIndex', 'el-icon-help', '', 'catalog', 67, 0, '2020-12-16 20:31:31', '2021-12-24 10:37:14');
INSERT INTO `cere_platform_permission` VALUES (68, 0, '平台活动', '', '/active', 'el-icon-finished', '', 'catalog', 68, 0, '2020-12-16 20:31:55', '2021-12-23 17:27:29');
...
INSERT INTO `cere_platform_permission` VALUES (709, 707, '拼团', NULL, '/marketing/group', 'el-icon-suitcase-1', NULL, 'menu', 709, 0, '2021-03-21 15:47:37', '2021-12-24 17:07:09');
...
INSERT INTO `cere_platform_permission` VALUES (911, 33, '优惠券活动', '', '/active/couponlist', 'el-icon-notebook-2', '', 'menu', 887, 1, '2021-08-21 17:39:04', '2021-12-07 15:47:05');
INSERT INTO `cere_platform_permission` VALUES (914, 33, '秒杀活动', '', '/active/seckilllist', 'el-icon-notebook-2', '', 'menu', 884, 1, '2021-08-21 17:56:10', '2021-12-07 15:46:51');
INSERT INTO `cere_platform_permission` VALUES (915, 33, '限时折扣', '', '/active/discountlist', 'el-icon-tickets', '', 'menu', 885, 1, '2021-08-21 17:56:58', '2021-12-07 15:46:56');
INSERT INTO `cere_platform_permission` VALUES (916, 33, '支付有礼', '', '/active/politelist', 'el-icon-reading', '', 'menu', 886, 1, '2021-08-21 17:57:33', '2021-12-07 15:47:01');
...
INSERT INTO `cere_platform_permission` VALUES (1603, 1602, '汽车管理', '', '/carManage/carList', 'el-icon-setting', '汽车列表管理', 'menu', 1172, 1, '2021-11-20 16:15:25', '2021-11-20 16:48:43');
INSERT INTO `cere_platform_permission` VALUES (1604, 1602, '汽车类别', '', '/carManage/carType', 'el-icon-film', '汽车类别', 'menu', 1173, 1, '2021-11-20 17:00:43', NULL);
INSERT INTO `cere_platform_permission` VALUES (1605, 1602, '类别参数', '', '/carManage/typeParam', 'el-icon-tickets', '类别参数', 'menu', 1174, 1, '2021-11-21 16:49:46', NULL);
INSERT INTO `cere_platform_permission` VALUES (1607, 1606, '房产管理', '', '/houseManage/houseList', 'el-icon-setting', '', 'button', 1176, 1, '2021-11-24 09:42:13', '2021-11-24 09:43:25');
INSERT INTO `cere_platform_permission` VALUES (1609, 1608, '房产管理', '', '/houseManage/houseList', 'el-icon-setting', '', 'menu', 1178, 1, '2021-11-24 09:46:10', NULL);
INSERT INTO `cere_platform_permission` VALUES (1610, 1608, '房产类型', '', '/houseManage/houseType', 'el-icon-film', '', 'menu', 1179, 1, '2021-11-24 09:53:26', '2021-11-24 09:56:12');
INSERT INTO `cere_platform_permission` VALUES (1611, 1608, '类别参数', '', '/houseManage/houseTypeParam', 'el-icon-notebook-2', '', 'menu', 1180, 1, '2021-11-24 09:55:32', NULL);
INSERT INTO `cere_platform_permission` VALUES (1613, 1612, '沙石管理', '', '/sandManage/sandList', 'el-icon-setting', '', 'menu', 1182, 1, '2021-11-24 10:03:11', NULL);
INSERT INTO `cere_platform_permission` VALUES (1614, 1612, '沙石类型', '', '/sandManage/sandType', 'el-icon-film', '', 'menu', 1183, 1, '2021-11-24 10:04:03', NULL);
INSERT INTO `cere_platform_permission` VALUES (1615, 1612, '类别分类', '', '/sandManage/sandTypeParam', 'el-icon-notebook-2', '', 'menu', 1184, 1, '2021-11-24 10:04:58', NULL);
INSERT INTO `cere_platform_permission` VALUES (1617, 1616, '再生管理', '', '/renewManage/renewList', 'el-icon-setting', '', 'menu', 1186, 1, '2021-11-24 10:16:45', NULL);
INSERT INTO `cere_platform_permission` VALUES (1618, 1616, '再生类型', '', '/renewManage/renewType', 'el-icon-film', '', 'menu', 1187, 1, '2021-11-24 10:17:22', NULL);
INSERT INTO `cere_platform_permission` VALUES (1619, 1616, '类别参数', '', '/renewManage/renewTypeParam', 'el-icon-notebook-2', '', 'menu', 1188, 1, '2021-11-24 10:18:10', NULL);
INSERT INTO `cere_platform_permission` VALUES (1621, 1620, '税务管理', '', '/taxManage/taxList', 'el-icon-setting', '', 'menu', 1190, 1, '2021-11-24 10:20:57', NULL);
INSERT INTO `cere_platform_permission` VALUES (1622, 1620, '税务类型', '', '/taxManage/taxType', 'el-icon-film', '', 'menu', 1191, 1, '2021-11-24 10:21:26', NULL);
INSERT INTO `cere_platform_permission` VALUES (1623, 1620, '类别参数', '', '/taxManage/taxTypeParam', 'el-icon-notebook-2', '', 'menu', 1192, 1, '2021-11-24 10:21:59', NULL);
INSERT INTO `cere_platform_permission` VALUES (1624, 0, '直播管理', '', '/liveMenu', 'el-icon-notebook-1', '', 'menu', 1193, 1, '2021-12-01 17:09:42', NULL);
INSERT INTO `cere_platform_permission` VALUES (1625, 0, '直播管理', '', '/liveMenu', 'zk-icon-system', '', 'catalog', 1194, 1, '2021-12-01 17:11:55', '2021-12-17 16:26:02');
...
INSERT INTO `cere_platform_permission` VALUES (1627, 1625, '直播间管理', '', '/liveMenu/liveRoom', 'el-icon-set-up', '', 'menu', 1196, 1, '2021-12-01 17:14:15', NULL);
...
INSERT INTO `cere_platform_permission` VALUES (1629, 1625, '直播商品管理', '', '/liveMenu/liveProduct', 'el-icon-goods', '', 'menu', 1198, 1, '2021-12-01 17:15:02', NULL);
...
INSERT INTO `cere_platform_permission` VALUES (1631, 1630, '广告管理', '', '/ad/coverConfig', 'el-icon-orange', '', 'menu', 1200, 1, '2021-12-01 17:17:35', '2021-12-01 17:35:24');
...
INSERT INTO `cere_platform_permission` VALUES (1685, 1632, 'IP黑名单', '', '/risk/IPBlacklist', 'el-icon-set-up', '', 'menu', 1220, 1, '2021-12-06 15:24:02', '2021-12-06 15:25:25');
INSERT INTO `cere_platform_permission` VALUES (1686, 1632, '用户黑名单', '', '/risk/userBlacklist', 'el-icon-set-up', '', 'menu', 1221, 1, '2021-12-06 15:30:26', NULL);
INSERT INTO `cere_platform_permission` VALUES (1687, 1632, '风控规则', '', '/risk/riskRules', 'el-icon-set-up', '', 'menu', 1222, 1, '2021-12-06 15:31:36', NULL);
INSERT INTO `cere_platform_permission` VALUES (1688, 0, '客服配置', '', '/customerService', 'el-icon-coordinate', '', 'menu', 1223, 1, '2021-12-06 17:17:11', NULL);
INSERT INTO `cere_platform_permission` VALUES (1689, 0, '客服管理', '', '/customerService', 'el-icon-coordinate', '', 'button', 1224, 1, '2021-12-06 17:19:19', NULL);
INSERT INTO `cere_platform_permission` VALUES (1690, 0, '客服配置', '', 'customerService', 'el-icon-coordinate', '', 'menu', 1225, 1, '2021-12-06 17:19:54', '2021-12-06 17:26:55');
INSERT INTO `cere_platform_permission` VALUES (1693, 0, '客服配置', '', 'customerService', 'el-icon-coordinate', '', 'menu', 1226, 1, '2021-12-06 17:28:33', '2021-12-08 14:55:07');
INSERT INTO `cere_platform_permission` VALUES (1697, 1696, '测试秒杀活动', '', '/active/seckill', 'el-icon-s-shop', '', 'menu', 1229, 1, '2021-12-07 15:56:49', '2021-12-07 16:05:10');
INSERT INTO `cere_platform_permission` VALUES (1698, 1696, '测试限时折扣', '', '/active/discount', 'el-icon-shopping-bag-1', '', 'menu', 1230, 1, '2021-12-07 16:03:33', NULL);
INSERT INTO `cere_platform_permission` VALUES (1699, 1696, '测试支付有礼', '', '/active/polite', 'el-icon-bank-card', '', 'menu', 1231, 1, '2021-12-07 16:04:14', NULL);
INSERT INTO `cere_platform_permission` VALUES (1700, 1696, '测试优惠卷', '', '/active/coupon', 'el-icon-s-ticket', '', 'menu', 1232, 1, '2021-12-07 16:04:51', NULL);
...
INSERT INTO `cere_platform_permission` VALUES (1702, 1701, '积分配置', '', '/integral/configuration', 'el-icon-setting', '', 'menu', 1234, 1, '2021-12-07 18:33:49', '2021-12-07 18:48:54');
INSERT INTO `cere_platform_permission` VALUES (1703, 1701, '积分记录', '', '/integral/record', 'el-icon-date', '', 'menu', 1235, 1, '2021-12-07 18:34:25', NULL);
INSERT INTO `cere_platform_permission` VALUES (1704, 1701, '签到天数配置', '', '/integral/signConfiguration', 'el-icon-edit', '', 'menu', 1236, 1, '2021-12-07 18:36:13', NULL);
...
INSERT INTO `cere_platform_permission` VALUES (1707, 1706, '微信客服配置', '', '/customerService', 'el-icon-service', '微信客服配置', 'menu', 1238, 1, '2021-12-08 15:01:00', '2021-12-13 10:14:16');
INSERT INTO `cere_platform_permission` VALUES (2175, 68, '平台活动', '', '/active', 'el-icon-camera', '', 'menu', 1263, 0, '2021-12-23 17:34:48', NULL);
INSERT INTO `cere_platform_permission` VALUES (2627, 0, '直播管理', '', '/liveMenu', 'el-icon-video-camera', '直播管理', 'catalog', 1264, 0, '2021-12-24 09:59:35', NULL);
INSERT INTO `cere_platform_permission` VALUES (2628, 2627, '直播间管理', '', '/liveMenu/liveRoom', 'el-icon-set-up', '直播间管理', 'menu', 1265, 0, '2021-12-24 10:00:30', NULL);
INSERT INTO `cere_platform_permission` VALUES (2629, 2627, '直播间商品管理', '', '/liveMenu/liveProduct', 'el-icon-shopping-bag-2', '直播间商品管理', 'menu', 1266, 0, '2021-12-24 10:01:22', NULL);
INSERT INTO `cere_platform_permission` VALUES (2630, 0, '客服管理', '', '/customerService', 'el-icon-chat-round', '客服管理', 'catalog', 1267, 0, '2021-12-24 10:02:19', NULL);
INSERT INTO `cere_platform_permission` VALUES (2631, 2630, '微信客服管理', '', '/customerService/service', 'el-icon-headset', '微信客服管理', 'menu', 1268, 0, '2021-12-24 10:03:18', NULL);
INSERT INTO `cere_platform_permission` VALUES (2633, 67, '分销员', '', '/distributor/index', 'el-icon-date', '', 'menu', 1270, 0, '2021-12-24 10:37:49', '2021-12-24 17:06:55');
INSERT INTO `cere_platform_permission` VALUES (3690, 707, '渠道优惠券管理', '', '/marketing/channelCoupons', 'el-icon-mobile-phone', '商家渠道优惠券', 'menu', 709, 0, '2021-12-27 09:32:34', '2021-12-27 18:39:55');
INSERT INTO `cere_platform_permission` VALUES (3723, 0, '测试', '', 'ceshi', 'el-icon-camera', '', 'menu', 1416, 1, '2021-12-27 19:05:53', NULL);
INSERT INTO `cere_platform_permission` VALUES (4025, 1, '手机号管理', '', '/setup/phone', 'el-icon-phone', '', 'menu', 1510, 1, '2022-02-15 15:27:54', '2022-02-15 16:08:07');
INSERT INTO `cere_platform_permission` VALUES (4092, 0, '二次认证管理', '', 'two', 'el-icon-view', '二次认证', 'catalog', 2, 1, '2022-02-18 10:50:01', '2022-02-18 10:55:19');
INSERT INTO `cere_platform_permission` VALUES (4094, 4092, '二次认证', '', '/setup/privacy', 'el-icon-finished', '', 'menu', 1533, 1, '2022-02-18 10:56:34', NULL);
INSERT INTO `cere_platform_permission` VALUES (4095, 0, '二次认证管理', '', 'two', 'el-icon-view', '', 'catalog', 2, 0, '2022-02-18 17:57:13', NULL);
INSERT INTO `cere_platform_permission` VALUES (4096, 4095, '二次认证', '', '/setup/privacy', 'el-icon-finished', '', 'menu', 1534, 0, '2022-02-18 17:57:55', NULL);
INSERT INTO `cere_platform_permission` VALUES (4097, 69, '手机号管理', '', '/setup/phone', 'el-icon-phone', '', 'menu', 1513, 0, '2022-02-15 18:31:09', NULL);
INSERT INTO `cere_platform_permission` VALUES (5354, 34, '品牌管理', '', '/renovation/brand', 'el-icon-collection', '品牌管理', 'menu', 10089, 1, '2022-08-29 14:46:58', NULL);
INSERT INTO `cere_platform_permission` VALUES (5348, 0, '渠道管理', '', '/channel', 'el-icon-truck', '渠道管理', 'catalog', 10085, 1, '2022-08-25 14:20:46', '2022-08-25 14:21:04');
INSERT INTO `cere_platform_permission` VALUES (5349, 5348, '渠道列表', '', '/channel/list', 'el-icon-tickets', '渠道列表', 'menu', 10086, 1, '2022-08-25 14:22:19', NULL);
INSERT INTO `cere_platform_permission` VALUES (5350, 707, '渠道券管理', '', '/marketing/channelManage', 'el-icon-school', '渠道券管理', 'menu', 10087, 0, '2022-08-25 15:30:26', '2022-08-25 15:31:17');
INSERT INTO `cere_platform_permission` VALUES (5351, 707, '渠道券活动', '', '/marketing/channelActivity', 'el-icon-attract', '渠道券活动', 'menu', 10088, 0, '2022-08-25 15:32:04', NULL);
COMMIT;
...
CREATE TABLE `cere_product_stats_by_day` (
  `create_date` char(10) COLLATE utf8mb4_bin NOT NULL COMMENT '日期',
  `product_id` bigint(20) NOT NULL COMMENT '商品id',
  `shop_id` bigint(20) NOT NULL COMMENT '店铺id',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='商品日度统计表';
...
CREATE TABLE `cere_scrm_verify` (
  `shop_id` bigint(20) NOT NULL COMMENT '店铺id',
  `encode_secret` varchar(64) COLLATE utf8mb4_bin NOT NULL COMMENT '秘钥编码之后的值',
  PRIMARY KEY (`shop_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT='scrm同步数据配置表';
...
CREATE TABLE `cere_shop_channel_activity` (
  ...
  `start_time` varchar(20) COLLATE utf8mb4_bin NOT NULL COMMENT '开始时间',
  `end_time` varchar(20) COLLATE utf8mb4_bin NOT NULL COMMENT '结束时间',
  ...
  `update_time` varchar(20) COLLATE utf8mb4_bin NOT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT='渠道活动表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT='渠道活动关联渠道券表';
...
CREATE TABLE `cere_shop_coupon` (
  ...
  `take_start` varchar(20) DEFAULT NULL COMMENT '领券开始时间',
  `take_end` varchar(20) DEFAULT NULL COMMENT '领券结束时间',
...
CREATE TABLE `cere_shop_customer_service` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键id',
  `shop_id` bigint(20) NOT NULL COMMENT '店铺id',
  `open_kfid` varchar(64) COLLATE utf8mb4_bin NOT NULL COMMENT '客服id',
  `create_time` varchar(20) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '创建时间',
  `update_time` varchar(20) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`),
  KEY `idx_shop_id` (`shop_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='店铺客服关联表';
...
CREATE TABLE `cere_shop_distribution_level` (
  ...
  `level_logo` varchar(1024) NOT NULL COMMENT '等级图标',
...
CREATE TABLE `cere_shop_order` (
  ...
  `old_price` decimal(15,2) DEFAULT NULL COMMENT '改价前的支付金额',
  ...
  `pricing_price` decimal(15,2) DEFAULT NULL COMMENT '定价捆绑优惠金额',
...
CREATE TABLE `cere_sign_product` (
  ...
  KEY `idx_productt_id` (`product_id`) USING BTREE
