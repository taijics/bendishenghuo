...
CREATE TABLE `cere_buyer_user` (
  ...
  `terminal` int(11) NOT NULL DEFAULT '0' COMMENT '终端 0-未知 1-APP 2-微信小程序 3-H5 4-支付宝小程序 5-PC',
  `create_time` varchar(20) DEFAULT NULL COMMENT '创建时间',
  `update_time` varchar(20) DEFAULT NULL COMMENT '更新时间',
...
CREATE TABLE `cere_order_product` (
  ...
  `logistics_price` decimal(15,4) NOT NULL DEFAULT '0.00' COMMENT '运费',
