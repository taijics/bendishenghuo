        ...
        <div class="content">
          <div class="formBox">
            <el-form
              ...
              :rules="personalRules"
              :label-position="'top'"
              ref="ruleForm" label-width="150px" class="ruleForm">
              <div class="formTit">
              ...
              <el-form-item label="组织名称" prop="otherName">
                <el-input maxlength="100" placeholder="请输入组织名称" v-model="personalForm.otherName"></el-input>
                <p>需与当地政府颁发的商业许可证书或企业注册证上的企业名称完全一致，信息审核审核成功后企业名称不可修改</p>
              </el-form-item>
              <el-form-item label="社会信用代码" prop="otherCode">
                <el-input maxlength="100" placeholder="请输入社会信用代码" v-model="personalForm.otherCode"></el-input>
              </el-form-item>
              <el-form-item label="注册地址" prop="otherRegion">
                <el-cascader
                  size="large"
                  :options="options"
              ...
              <el-form-item label="" prop="otherAdress">
                <el-input maxlength="200" resize="none" placeholder="请输入详细地址" type="textarea" :rows="3" v-model="personalForm.otherAdress"></el-input>
              </el-form-item>
              <div class="dateBox">
                <el-form-item label="营业期限" prop="otherStartTime" class="businessDate">
                  <el-date-picker
                    v-model="personalForm.otherStartTime"
                    type="date"
                    placeholder="选择日期"
                  ...
                  <el-date-picker
                    v-model="personalForm.otherEndTime"
                    type="date"
                    placeholder="选择日期"
                    format="yyyy 年 MM 月 dd 日"
                    value-format="yyyy-MM-dd">
                ...
                <div class="idImgesBox">
                  <div class="idImgaeLeft">
                    <el-upload
                      ...
                      <img v-if="personalForm.otherLicense" :src="personalForm.otherLicense" class="avatar">
                      ...
                      <div class="bgInfo">机构证件</div>
                    </el-upload>
                    <p>此处提交机构证件及其他证明材料。仅支持在有效期内的中国大陆工商局或市场监督管理局颁发的工商营业执照。格式要求：原证照片、扫描件或者复印件加盖企业公章后的扫描件，支持.jpg .jpeg .bmp .gif .png格式照片。</p>
                  </div>
                </div>
              </el-form-item>
              <div class="formTit">
              ...
              <el-form-item label="负责人姓名" prop="otherOperator">
                <el-input maxlength="100" placeholder="请输入负责人姓名" v-model="personalForm.otherOperator"></el-input>
              </el-form-item>
              <el-form-item label="证件类型" prop="otherCardType" class="idType">
                <el-select v-model="personalForm.otherCardType" placeholder="请选择">
                  <el-option
              ...
              <el-form-item label="身份证号码" prop="otherIdCard">
                <el-input maxlength="100" placeholder="请输入身份证号码" v-model="personalForm.otherIdCard"></el-input>
              </el-form-item>
              <div class="dateBox idDateBox">
                <el-form-item label="身份证有效期" prop="otherCardStartTime" class="businessDate">
                  <el-date-picker
                    v-model="personalForm.otherCardStartTime"
                    type="date"
                    placeholder="选择日期"
                    format="yyyy 年 MM 月 dd 日"
                    value-format="yyyy-MM-dd">
                  ...
                  <span class="description">至</span>
                  <el-date-picker
                    v-model="personalForm.otherCardEndTime"
                    type="date"
                    placeholder="选择日期"
                    format="yyyy 年 MM 月 dd 日"
                    value-format="yyyy-MM-dd">
              ...
              <el-form-item label="证件照片" prop="otherCardPositive">
                <div class="idImgesBox">
                  <div class="idImgaeLeft">
                    <el-upload
                      list-type="picture-card"
                      ...
                      <img v-if="personalForm.otherCardPositive" :src="personalForm.otherCardPositive" class="avatar">
                      <div v-else class="noImg">
                        <div class="bgBox">
                  ...
                  <div class="idImgaeRight">
                    <el-upload
                      ...
                      <img v-if="personalForm.otherCardSide" :src="personalForm.otherCardSide" class="avatar">
                      <div v-else class="noImg">
                        <div class="bgBox">
...
export default {
  ...
  data () {
    return {
      ...
      personalRules: {
        ...
        otherStartTime: [{required: true, message: '请选择营业执照起始日期'}],
        otherEndTime: [{required: true, message: '请选择营业执照到期时间'}],
        otherLicense: [
        ...
        otherCardStartTime: [{required: true, message: '请选择身份证起始日期'}],
        otherCardEndTime: [{required: true, message: '请选择身份证到期时间'}],
        otherCardType: [
        ...
        otherCardSide: [
          { required: true, message: '请选择上传手持身份证照片', trigger: 'change' }
        ]
      },
      dialogImageUrl: '',
      dialogVisible: false,
  ...
  methods: {
    ...
    handleIdPositive (res, file) {
      this.personalForm.otherCardPositive = res.data.url
    },
    handleIdBack (res, file) {
      this.personalForm.otherCardSide = res.data.url
    },
    ...
    submitForm (formName) {
      this.$refs[formName].validate(valid => {
        if (valid) {
          // alert('submit!')storeAddressDetail
