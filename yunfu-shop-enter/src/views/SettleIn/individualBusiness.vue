        ...
        <div class="content">
          <div class="formBox">
            ...
            class="ruleForm">
              ...
              <el-form-item label="商户名称" prop="subjectName">
                <el-input maxlength="100" placeholder="请输入商户名称" v-model="personalForm.subjectName"></el-input>
                <p>需与当地政府颁发的商业许可证书或企业注册证上的企业名称完全一致，信息审核审核成功后企业名称不可修改</p>
              </el-form-item>
              <el-form-item label="社会信用代码" prop="subjectCode">
                <el-input maxlength="100" placeholder="请输入社会信用代码" v-model="personalForm.subjectCode"></el-input>
              </el-form-item>
              ...
              <el-form-item label="" prop="subjectAdress">
                <el-input maxlength="200" resize="none" placeholder="请输入详细地址" type="textarea" :rows="3" v-model="personalForm.subjectAdress"></el-input>
              </el-form-item>
              <div class="dateBox">
                <el-form-item label="营业期限" prop="subjectStartTime" class="businessDate">
                  <el-date-picker
                    v-model="personalForm.subjectStartTime"
                    type="date"
                    placeholder="选择日期"
                  ...
                  <el-date-picker
                    v-model="personalForm.subjectEndTime"
                    type="date"
                    placeholder="选择日期"
                    format="yyyy 年 MM 月 dd 日"
                    value-format="yyyy-MM-dd">
                ...
                <div class="idImgesBox">
                  <div class="idImgaeLeft">
                    <el-upload
                      ...
                      <img v-if="personalForm.subjectLicense" :src="personalForm.subjectLicense" class="avatar">
              ...
              <el-form-item label="经营者姓名" prop="subjectOperator">
                <el-input maxlength="100" placeholder="请输入经营者姓名" v-model="personalForm.subjectOperator"></el-input>
              </el-form-item>
              <el-form-item label="证件类型" prop="subjectCardType" class="idType">
                <el-select v-model="personalForm.subjectCardType" placeholder="请选择">
                  <el-option
              ...
              <el-form-item label="身份证号码" prop="subjectIdCard">
                <el-input maxlength="100" placeholder="请输入身份证号码" v-model="personalForm.subjectIdCard"></el-input>
              </el-form-item>
              <div class="dateBox idDateBox">
                <el-form-item label="身份证有效期" prop="subjectCardStartTime" class="businessDate">
                  <el-date-picker
                    v-model="personalForm.subjectCardStartTime"
                    type="date"
                    placeholder="选择日期"
                    format="yyyy 年 MM 月 dd 日"
                    value-format="yyyy-MM-dd">
                  ...
                  <span class="description">至</span>
                  <el-date-picker
                    v-model="personalForm.subjectCardEndTime"
                    type="date"
                    placeholder="选择日期"
                    format="yyyy 年 MM 月 dd 日"
                    value-format="yyyy-MM-dd">
              ...
              <el-form-item label="证件照片" prop="subjectCardPositive">
                <div class="idImgesBox">
                  <div class="idImgaeLeft">
                    <el-upload
                      list-type="picture-card"
                      ...
                      <img v-if="personalForm.subjectCardPositive" :src="personalForm.subjectCardPositive" class="avatar">
                      <div v-else class="noImg">
                        <div class="bgBox">
                  ...
                  <div class="idImgaeRight">
                    <el-upload
                      ...
                      <img v-if="personalForm.subjectCardSide" :src="personalForm.subjectCardSide" class="avatar">
                      <div v-else class="noImg">
                        <div class="bgBox">
...
export default {
  ...
  data () {
    return {
      ...
      personalRules: {
        ...
        subjectStartTime: [{required: true, message: '请选择营业执照起始日期'}],
        subjectEndTime: [{required: true, message: '请选择营业执照到期时间'}],
        subjectLicense: [
        ...
        subjectCardStartTime: [{required: true, message: '请选择身份证起始日期'}],
        subjectCardEndTime: [{required: true, message: '请选择身份证到期时间'}],
        subjectCardType: [
  ...
  methods: {
    ...
    handleIdPositive (res, file) {
      this.personalForm.subjectCardPositive = res.data.url
      console.log(this.personalForm.subjectCardPositive)
    },
    handleIdBack (res, file) {
      this.personalForm.subjectCardSide = res.data.url
      console.log(this.personalForm.subjectCardPositive)
    },
    handleHandHeld (res, file) {
      this.personalForm.subjectLicense = res.data.url
