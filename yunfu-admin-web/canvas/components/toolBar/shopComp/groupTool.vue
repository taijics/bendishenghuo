      ...
      >
        <el-table-column label width="35">
          <template #default="scope">
            <el-radio v-model="radioId" :label="scope.row.shopGroupWorkId" />
          </template>
        </el-table-column>
        <el-table-column prop="groupName" label="标题" />
...
function confirmActivity () {
  activeComponent.value.componentContent.shopGroupWorkId =
        selectSkill.value.shopGroupWorkId
  activeComponent.value.componentContent.activityName =
        selectSkill.value.groupName
